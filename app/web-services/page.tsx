    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="pt-[120px] pb-24">
        ...
        <section className="px-4 sm:px-8 pt-12 sm:pt-20 md:pt-28 mb-16 max-w-7xl mx-auto text-center relative">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            <span className="inline-block px-4 py-1.5 rounded-full border border-primary/25 bg-primary/[0.08] text-primary font-bold text-xs tracking-widest uppercase mb-6">Web Services</span>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-headline font-extrabold tracking-tight text-white mb-6 leading-tight">
              Beyond eCommerce — digital infrastructure built to scale.
            </h1>
      ...
      <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
        <div className="bg-surface-container rounded-3xl p-8 border border-outline-variant/10 hover:-translate-y-1 transition-transform">
          ...
          <h2 className="text-2xl font-headline font-bold text-white mb-4">Website Development</h2>
          <p className="text-on-surface-variant text-sm leading-relaxed mb-6">Fast, professional, and SEO-ready websites. We build business sites, landing pages, and custom web applications.</p>
          <Link href="/web-services/development" className="text-primary font-bold text-sm inline-flex items-center group">
            Explore Web Development <span className="material-symbols-outlined ml-1 text-[16px] transition-transform group-hover:translate-x-1">arrow_forward</span>
          </Link>
        </div>
        <div className="bg-surface-container rounded-3xl p-8 border border-outline-variant/10 hover:-translate-y-1 transition-transform">
          <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-6">
          ...
          <h2 className="text-2xl font-headline font-bold text-white mb-4">Website Hosting</h2>
          <p className="text-on-surface-variant text-sm leading-relaxed mb-6">Fast, secure, and managed website hosting. Includes SSL, speed optimization, uptime monitoring, and daily backups.</p>
          <Link href="/web-services/hosting" className="text-primary font-bold text-sm inline-flex items-center group">
            Explore Web Hosting <span className="material-symbols-outlined ml-1 text-[16px] transition-transform group-hover:translate-x-1">arrow_forward</span>
          </Link>
        </div>
        <div className="bg-surface-container rounded-3xl p-8 border border-outline-variant/10 hover:-translate-y-1 transition-transform">
          <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-6">
          ...
          <h2 className="text-2xl font-headline font-bold text-white mb-4">DevOps & Deployment</h2>
          <p className="text-on-surface-variant text-sm leading-relaxed mb-6">Server setup, CI/CD pipelines, Docker containerization, and application deployment for reliable, scalable production environments.</p>
          <Link href="/web-services/devops" className="text-primary font-bold text-sm inline-flex items-center group">
            Explore DevOps <span className="material-symbols-outlined ml-1 text-[16px] transition-transform group-hover:translate-x-1">arrow_forward</span>
          </Link>
        </div>
      </div>
