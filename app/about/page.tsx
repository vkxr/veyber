...
<span className="inline-block px-4 py-1.5 rounded-full bg-secondary-container text-on-secondary-container text-xs font-bold tracking-widest uppercase mb-6">Established in Vadodara</span>
<h1 className="text-5xl md:text-7xl font-extrabold font-headline tracking-tight leading-tight mb-8">
...
{/* Floating stat badge */}
<div className="absolute -bottom-6 -left-6 p-8 bg-surface-container-highest rounded-2xl shadow-xl border border-outline-variant/10 backdrop-blur-sm">
<div className="text-4xl font-bold font-headline text-primary">150+</div>
...
<div className="force-dark md:col-span-4 relative bg-neutral-900 rounded-2xl overflow-hidden flex flex-col justify-end min-h-[400px] group">
...
<h2 className="text-3xl font-bold font-headline mb-4 text-white">Who We Are</h2>
...
<div className="force-dark md:col-span-8 relative bg-neutral-900 rounded-2xl overflow-hidden min-h-[400px] group">
...
<h2 className="text-3xl font-bold font-headline mb-4 text-white uppercase tracking-widest drop-shadow-lg">Our Story</h2>
<p className="text-white/80 text-lg leading-relaxed max-w-xl drop-shadow">Founded with a vision to bridge the gap between local craft and global reach, Veyber started as a small team in Vadodara with one goal: to redefine how brands communicate in the digital age.</p>
</div>
</div>
</div>
</div>
...
<div className="max-w-7xl mx-auto">
<h2 className="text-4xl font-bold font-headline mb-16 text-center">Leadership Messages</h2>
<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
{/*  Founder  */}
<div className="bg-surface-container-high p-8 rounded-2xl border border-outline-variant/5">
...
<div>
<h2 className="text-4xl font-bold font-headline mb-8">Why Choose Veyber?</h2>
...
<div className="bg-surface-container p-12 rounded-3xl border border-outline-variant/10 relative overflow-hidden">
<div className="absolute top-0 right-0 w-32 h-32 bg-primary/10 rounded-bl-full filter blur-3xl"></div>
<h2 className="text-4xl font-bold font-headline mb-8">Our Approach</h2>
...
<section className="px-8 py-24 bg-surface-container-low text-center">
<div className="max-w-4xl mx-auto">
<h2 className="text-4xl font-bold font-headline mb-6">Who We Work With</h2>
<p className="text-lg text-on-surface-variant mb-12">From Vadodara's promising startups to established manufacturing giants across Gujarat, we partner with visionaries who are ready to scale.</p>
<div className="flex flex-wrap justify-center gap-6 mb-24 opacity-60">
...
<div className="p-12 rounded-2xl bg-gradient-to-br from-primary/10 to-primary-container/10 border border-primary/20">
<h3 className="text-2xl font-bold font-headline mb-4 uppercase tracking-widest">Our Commitment</h3>
<p className="text-lg leading-relaxed text-on-surface">We commit to transparency, relentless innovation, and a results-oriented mindset. When you work with Veyber, you aren't just hiring an agency; you're gaining a growth partner dedicated to your long-term success.</p>
</div>
</div>
</section>
{/*  FAQ Section  */}
