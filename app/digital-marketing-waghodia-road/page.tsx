...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Waghodia Road Vadodara | SEO, SMM, Ecommerce – Veyber',
  description: 'Looking for digital marketing services in Waghodia Road Vadodara? Veyber offers ecommerce, social media marketing, content marketing & consulting services.',
  keywords: 'Digital marketing services Waghodia Road Vadodara, Social media marketing Waghodia Road, Ecommerce development Waghodia Road, SEO services Waghodia Road Vadodara, Digital agency Waghodia Road, Marketing company Vadodara, Business consultant Waghodia Road',
};
...
const pageSchema = {
  ...
  address: {
    '@type': 'PostalAddress',
    addressLocality: 'Waghodia Road',
    addressRegion: 'Gujarat',
    addressCountry: 'India',
  },
  description: 'Digital marketing services in Waghodia Road Vadodara including ecommerce development, social media marketing, content marketing and business consulting.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Waghodia Road Vadodara?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we offer complete digital marketing services in Waghodia Road and nearby areas.',
      },
    },
    {
      '@type': 'Question',
      name: 'Can you help growing businesses?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we specialize in helping startups and local businesses grow online.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  {
    ...
    desc: 'Expand your business online with high-performing websites.',
    items: ['Shopify, WooCommerce & custom solutions', 'Mobile-friendly & SEO-optimized', 'Secure and scalable'],
    href: '/ecommerce-development',
  },
  {
    icon: 'storefront',
    title: 'Ecommerce Account Management',
    desc: 'Boost your online sales across marketplaces.',
    items: ['Amazon, Flipkart & Meesho management', 'Product listing optimization', 'Sales growth strategies'],
    href: '/account-management',
  },
  {
    icon: 'share',
    title: 'Social Media Handling in Waghodia Road',
    desc: 'Engage your local audience and build your brand.',
    items: ['Instagram & Facebook management', 'Content creation & posting', 'Paid ads campaigns'],
    href: '/social-media-handling',
  },
  {
    icon: 'edit_note',
    title: 'Content Marketing',
    desc: 'Drive traffic and attract the right customers.',
  ...
  },
  {
    ...
    items: ['Business growth planning', 'Market research', 'Process optimization'],
    href: '/business-consulting',
  },
];

const process = [
  { n: '01', label: 'Business Understanding', desc: 'Deep dive into your operations and goals.' },
  { n: '02', label: 'Local Market Analysis', desc: 'Waghodia Road-focused research and positioning strategy.' },
  { n: '03', label: 'Strategy Creation', desc: 'Developing bespoke action plans and campaign setups.' },
  { n: '04', label: 'Execution', desc: 'Rolling out localized campaigns efficiently.' },
...
const results = [
  ...
  { icon: 'people', stat: 'Higher', label: 'Engagement' },
  { icon: 'payments', stat: 'Better', label: 'Conversions' },
  { icon: 'timeline', stat: 'Long-term', label: 'Business Growth' },
];

const faqs = [
  {
    q: 'Do you provide services in Waghodia Road Vadodara?',
    a: 'Yes, we offer complete digital marketing services in Waghodia Road and nearby areas.',
  },
  {
    q: 'Can you help growing businesses?',
    a: 'Yes, we specialize in helping startups and local businesses grow online.',
  },
  {
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/25 bg-primary/[0.08] text-primary font-bold text-xs tracking-widest uppercase mb-5">
              ...
              Grow Your Business with Veyber
            </span>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Waghodia Road</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Grow Your Business with Veyber – Local Growth Experts
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              Looking for professional digital marketing services in Waghodia Road, Vadodara? At Veyber, we help businesses in Waghodia Road build a strong online presence, attract local customers, and increase revenue using data-driven digital strategies. Whether you&apos;re a local business, startup, or ecommerce brand—we help you grow faster and stay ahead of the competition.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate Waghodia Road</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses on Waghodia Road Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Waghodia Road is a rapidly developing residential and commercial corridor, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'New housing societies' },
                     { text: 'Local shops & retail businesses' },
                     { text: 'Clinics & service providers' },
                     { text: 'Growing population and demand' }
                  ].map(({ text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates high opportunity + increasing competition. To succeed, you need: <span className="text-primary">Strong local SEO visibility, active social media presence, and consistent online branding.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Waghodia Road</h3>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Waghodia Road</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Data-driven digital strategies to help you grow faster and stay ahead of the competition.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We deploy customized strategies for growing areas like Waghodia Road, delivering maximum value with dedicated support.</p>
                
                <div className="space-y-4 mb-8">
                  <ul className="space-y-4">
                    {[
                      'Local expertise in Vadodara',
                      'Customized strategies for growing areas like Waghodia Road',
                      'Affordable pricing',
                      'Dedicated support',
              ...
              <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                ...
                <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Waghodia Road & Nearby Areas</h3>
                <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                  We are deeply integrated into the local grid, serving primary residential and commercial zones seamlessly.
                </p>
                
                <div className="flex flex-wrap gap-2 mb-6 relative z-10">
                  {['Waghodia Road', 'Ajwa Road', 'Karelibaug', 'Nizampura', 'Nearby areas of Vadodara'].map((area) => (
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Common insights regarding our local Waghodia Road operations.</p>
            </div>
