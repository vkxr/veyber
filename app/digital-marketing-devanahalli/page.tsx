...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Devanahalli Bangalore | Real Estate Leads – Veyber',
  description: 'Looking for digital marketing services in Devanahalli Bangalore? Veyber offers SEO, social media marketing, ecommerce & real estate lead generation services.',
  keywords: 'Digital marketing services Devanahalli, SEO company Devanahalli Bangalore, Real estate marketing Devanahalli, Marketing agency Devanahalli, Property marketing Bangalore North, Airport corridor marketing, Real estate leads Bangalore, Business consultant Devanahalli',
};
...
const pageSchema = {
  ...
  description: 'Digital marketing services in Devanahalli Bangalore including SEO, social media marketing, ecommerce development and real estate lead generation.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Devanahalli Bangalore?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we provide complete digital marketing services in Devanahalli and North Bangalore.',
      },
    },
    {
      '@type': 'Question',
      name: 'Do you work with real estate companies?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we specialize in real estate lead generation and property marketing.',
      },
    },
    {
      '@type': 'Question',
      name: 'Do you provide SEO services for builders?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we focus on high-intent SEO for real estate businesses.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  {
    ...
    desc: 'Build scalable digital platforms.',
    items: ['Shopify, WooCommerce & custom websites', 'Mobile-first conversion design', 'Performance optimization'],
    href: '/ecommerce-development',
  },
  {
    icon: 'storefront',
    title: 'Ecommerce Account Management',
    desc: 'Scale online marketplace sales.',
    items: ['Amazon, Flipkart & Meesho management', 'Listing optimization', 'Growth strategy execution'],
    href: '/account-management',
  },
  {
    icon: 'share',
    title: 'Social Media Marketing',
    desc: 'Generate high-quality leads.',
    items: ['Instagram & Facebook campaigns', 'Real estate ad funnels', 'Video & reel marketing'],
    href: '/social-media-handling',
  },
  {
    icon: 'edit_note',
    title: 'Content Marketing',
    desc: 'Build authority in competitive markets.',
    items: ['SEO blogs & landing pages', 'Real estate keyword targeting', 'Investment-focused content'],
    href: '/content-marketing',
  },
  {
    icon: 'psychology',
    title: 'Business Consulting',
    desc: 'Improve conversion strategy.',
    items: ['Real estate funnel planning', 'Lead generation strategy', 'Brand positioning for high-ticket sales'],
    href: '/business-consulting',
  },
];

const process = [
  { n: '01', label: 'Market Analysis', desc: 'Identify your true potential within the Devanahalli growth zone.' },
  { n: '02', label: 'Audience Segmentation', desc: 'Targeting high-value investment demographics.' },
  { n: '03', label: 'Strategy Creation', desc: 'Developing bespoke conversion-focused action plans.' },
  { n: '04', label: 'Campaign Execution', desc: 'Rolling out highly optimized multi-channel campaigns.' },
  { n: '05', label: 'Lead Optimization', desc: 'Refining data and scaling property sales pipelines.' },
];

const results = [
  { icon: 'contacts', stat: 'High-quality', label: 'Property Leads' },
  { icon: 'stars', stat: 'Better', label: 'Google Rankings' },
  { icon: 'people', stat: 'Increased', label: 'Brand Visibility' },
  { icon: 'payments', stat: 'Strong', label: 'Investor Inquiries' },
  { icon: 'timeline', stat: 'Consistent', label: 'Lead Flow' },
];

const faqs = [
  {
    q: 'Do you provide services in Devanahalli Bangalore?',
    a: 'Yes, we provide complete digital marketing services in Devanahalli and North Bangalore.',
  },
  {
    q: 'Do you work with real estate companies?',
    a: 'Yes, we specialize in real estate lead generation and property marketing.',
  },
  {
    q: 'Do you provide SEO services for builders?',
    a: 'Yes, we focus on high-intent SEO for real estate businesses.',
  },
  {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="pt-[120px]">
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/25 bg-primary/[0.08] text-primary font-bold text-xs tracking-widest uppercase mb-5">
              ...
              Growth-Focused SEO & Lead Generation by Veyber
            </span>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Devanahalli, Bangalore</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Looking for result-driven digital marketing services in Devanahalli, Bangalore?
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              At Veyber, we help real estate companies, startups, and local businesses in Devanahalli grow through SEO, social media marketing, and performance-based lead generation systems. We focus on high-intent leads, visibility, and long-term growth in emerging markets.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Capture Real Estate Leads</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Devanahalli Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Devanahalli is one of Bangalore&apos;s fastest-growing investment zones, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'Kempegowda International Airport proximity' },
                     { text: 'Real estate townships & plotted developments' },
                     { text: 'Logistics & warehousing hubs' },
                     { text: 'Hospitality & tourism growth' },
                     { text: 'Upcoming commercial corridors' }
                  ].map(({ text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates high-value lead opportunities with growing competition. To succeed here, you need: <span className="text-primary">Strong Google visibility, real estate-focused SEO, and high-intent lead generation systems.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Devanahalli</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 relative z-10 w-full">
                  {[
                    ...
                    'Startups near airport corridor',
                  ].map((ind) => (
        ...
        {/* Our Services in Devanahalli */}
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Devanahalli</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Systemized tracking to convert Devanahalli&apos;s massive real estate and logistics trajectory heavily.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We deploy localized frameworks engineered strictly for high-value closures targeting Devanahalli&apos;s rapid capital and infrastructural inflows.</p>
                
                <div className="space-y-4 mb-8">
                  <ul className="space-y-4">
                    {[
                      'Real estate marketing expertise',
                      'High-value lead generation systems',
                      'Strong SEO execution',
                      'Affordable growth strategies',
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                  ...
                  <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Devanahalli & Nearby</h3>
                  <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                    We cover local search channels stretching entirely across the Northern infrastructure expansion belt.
                  </p>
                  
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {['Devanahalli', 'Airport Road corridor', 'Yelahanka', 'Hebbal', 'North Bangalore industrial zones', 'Bangalore expansion belt'].map((area) => (
                ...
                <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full">
                  ...
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {[
                      ...
                      { name: 'Yelahanka', url: '/digital-marketing-yelahanka' },
                      { name: 'Hebbal', url: '/digital-marketing-hebbal' },
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-20 bg-surface-container-low">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-on-surface-variant text-sm mb-10 max-w-lg mx-auto">Locking down high-ticket real estate pipelines aggressively around the Northern Airport corridors.</p>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Vital insights regarding our capacity scaling natively inside the Devanahalli development zone.</p>
            </div>
          ...
          <div className="force-dark max-w-4xl mx-auto text-center relative z-10 bg-neutral-900 rounded-[2rem] sm:rounded-[3rem] border border-white/15 overflow-hidden">
            ...
            <div className="relative z-10 p-8 sm:p-12 md:p-16">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary font-bold text-xs tracking-widest uppercase mb-6">
                <span className="relative flex h-1.5 w-1.5 shrink-0"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"/><span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-primary"/></span>
                Let’s Grow Your Business in Devanahalli
              </span>
              ...
              <p className="text-base sm:text-lg text-white/75 mb-8 max-w-xl mx-auto leading-relaxed drop-shadow">
                Contact Veyber for digital marketing services in Devanahalli, Bangalore.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
