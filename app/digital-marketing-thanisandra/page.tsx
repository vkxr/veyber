...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Thanisandra Bangalore | Real Estate & IT Leads – Veyber',
  description: 'Looking for digital marketing services in Thanisandra Bangalore? Veyber offers SEO, social media marketing, ecommerce & lead generation services.',
  keywords: 'Digital marketing services Thanisandra, SEO company Thanisandra Bangalore, Marketing agency Thanisandra, Local SEO Thanisandra, Real estate marketing North Bangalore, IT marketing Bangalore, Apartment marketing Thanisandra, Business consultant Thanisandra',
};
...
const pageSchema = {
  ...
  description: 'Digital marketing services in Thanisandra Bangalore including SEO, social media marketing, ecommerce development and real estate & IT lead generation.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Thanisandra Bangalore?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we provide complete digital marketing services in Thanisandra and North Bangalore.',
      },
    },
    {
      '@type': 'Question',
      name: 'Do you work with real estate developers?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we specialize in real estate lead generation and marketing.',
      },
    },
    {
      '@type': 'Question',
      name: 'Do you provide SEO for IT businesses?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we help IT companies improve visibility and leads.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  {
    ...
    items: ['Shopify, WooCommerce & custom websites', 'Mobile-first conversion design', 'Lead capture optimization'],
    href: '/ecommerce-development',
  },
  {
    icon: 'storefront',
    title: 'Ecommerce Account Management',
    desc: 'Scale online revenue.',
    items: ['Amazon, Flipkart & Meesho management', 'Listing optimization', 'Marketplace growth strategy'],
    href: '/account-management',
  },
  {
    icon: 'share',
    title: 'Social Media Marketing',
    desc: 'Reach IT + residential audience.',
    items: ['Instagram & Facebook ads', 'Real estate reels & campaigns', 'Targeted local advertising'],
  ...
  },
  {
    ...
    items: ['SEO blogs & landing pages', 'Real estate + IT keyword targeting', 'Authority content creation'],
  ...
  },
  {
    ...
    items: ['Real estate funnel planning', 'Lead generation strategy', 'Brand positioning'],
    href: '/business-consulting',
  },
];

const process = [
  { n: '01', label: 'Market Research', desc: 'Identify your true potential in the Thanisandra + Manyata belt.' },
  { n: '02', label: 'Competitor Analysis', desc: 'Mapping tech-driven buyer intent and property demand.' },
  ...
  { n: '05', label: 'Optimization & Scaling', desc: 'Refining data and predicting scalable lead loops.' },
];
...
const results = [
  ...
  { icon: 'payments', stat: 'Increased', label: 'Inquiries' },
  { icon: 'timeline', stat: 'Consistent', label: 'Monthly Lead Flow' },
];

const faqs = [
  {
    q: 'Do you provide services in Thanisandra Bangalore?',
    a: 'Yes, we provide complete digital marketing services in Thanisandra and North Bangalore.',
  },
  {
    q: 'Do you work with real estate developers?',
    a: 'Yes, we specialize in real estate lead generation and marketing.',
  },
  {
    q: 'Do you provide SEO for IT businesses?',
    a: 'Yes, we help IT companies improve visibility and leads.',
  },
  {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="pt-[120px]">
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/25 bg-primary/[0.08] text-primary font-bold text-xs tracking-widest uppercase mb-5">
              ...
              High-Growth SEO & Lead Generation by Veyber
            </span>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Thanisandra, Bangalore</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Looking for reliable digital marketing services in Thanisandra, Bangalore?
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              At Veyber, we help real estate developers, IT-based businesses, and local service providers in Thanisandra grow through SEO, social media marketing, and performance-driven lead generation systems. We focus on high-quality leads, visibility, and scalable business growth.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate North Bangalore Search</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Thanisandra Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Thanisandra is one of North Bangalore&apos;s fastest-growing residential and IT-linked hubs, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'Proximity to Manyata Tech Park' },
                     { text: 'High-rise apartment developments' },
                     { text: 'IT professionals & rental demand' },
                     { text: 'Retail and lifestyle expansion' },
                     { text: 'Rapid infrastructure growth' }
                  ].map(({ text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates high buyer intent and strong competition among developers and service providers. To grow here, you need: <span className="text-primary">Strong Google visibility, real estate + IT audience targeting, and high-conversion lead funnels.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Thanisandra</h3>
        ...
        {/* Our Services in Thanisandra */}
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Thanisandra</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Systemized tracking to convert traffic generated from IT corridors and apartment hubs.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We orchestrate deeply rooted frameworks targeting exclusively IT & property searchers running along the Northern infrastructure belt.</p>
                
                <div className="space-y-4 mb-8">
                  <ul className="space-y-4">
                    {[
                      'Strong IT + real estate marketing expertise',
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                  ...
                  <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Thanisandra & Nearby</h3>
                  <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                    Our local market pipelines overlap heavily with the major tech parks dominating North Bangalore.
                  </p>
                  
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {['Thanisandra', 'Manyata Tech Park', 'Nagawara', 'Hebbal', 'Hennur Road', 'North Bangalore'].map((area) => (
                ...
                <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full">
                  ...
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {[
                      ...
                      { name: 'Hennur Road', url: '/digital-marketing-hennur-road' },
                      { name: 'Manyata Tech Park', url: '/digital-marketing-manyata-tech-park' },
                    ].map((city) => (
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-20 bg-surface-container-low">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-on-surface-variant text-sm mb-10 max-w-lg mx-auto">Intercepting high-ticket tech salaries scaling straight into Thanisandra&apos;s real estate ecosystems.</p>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Vital insights regarding our capacity targeting real estate ecosystems around Thanisandra.</p>
            </div>
