...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Jigani Bangalore | Industrial & Export Leads – Veyber',
  description: 'Looking for digital marketing services in Jigani Bangalore? Veyber offers SEO, social media marketing, ecommerce & industrial B2B lead generation services.',
  keywords: 'Digital marketing services Jigani, SEO company Jigani Bangalore, Industrial marketing Jigani, B2B lead generation Jigani, Manufacturing marketing Bangalore, Export marketing Jigani, Industrial SEO Karnataka, B2B growth marketing India',
};
...
const pageSchema = {
  ...
  description: 'Digital marketing services in Jigani Bangalore including SEO, social media marketing, ecommerce development and industrial B2B lead generation.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Jigani Bangalore?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we provide complete digital marketing services in Jigani and South Bangalore industrial belt.',
      },
    },
    {
      '@type': 'Question',
      name: 'Do you work with export companies?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we specialize in export and manufacturing marketing.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  {
    ...
    desc: 'Build industrial digital systems.',
    items: ['B2B manufacturing websites', 'Product catalog & inquiry systems', 'Lead generation landing pages'],
    href: '/ecommerce-development',
  },
  {
    icon: 'storefront',
    title: 'Ecommerce Account Management',
    desc: 'Expand sales channels.',
  ...
  },
  {
    ...
    items: ['LinkedIn B2B campaigns', 'Industrial branding content', 'Paid lead generation ads'],
    href: '/social-media-handling',
  },
  {
    icon: 'edit_note',
    title: 'Content Marketing',
    desc: 'Build industrial authority.',
    items: ['SEO blogs for manufacturing', 'Technical content writing', 'Industry keyword targeting'],
  ...
  },
  {
    ...
    items: ['Export strategy planning', 'B2B lead generation systems', 'Industrial branding & positioning'],
    href: '/business-consulting',
  },
];

const process = [
  { n: '01', label: 'Market Analysis', desc: 'Isolating global search intent targeting the Jigani and Anekal manufacturing belts.' },
  { n: '02', label: 'Competitor Research', desc: 'Decoding digital pipelines of major pharma, chemical, and export networks.' },
  { n: '03', label: 'Strategy Planning', desc: 'Systematizing robust export-focused B2B infrastructure pipelines.' },
  { n: '04', label: 'Execution', desc: 'Deploying heavy SEO markers to secure industrial global buyer traffic.' },
  { n: '05', label: 'Optimization', desc: 'Continuous scaling to funnel high-value enterprise contracts regularly.' },
];
...
const results = [
  ...
  { icon: 'visibility', stat: 'Increased', label: 'Export Inquiries' },
  { icon: 'timeline', stat: 'Long-term', label: 'Business Contracts' },
];

const faqs = [
  {
    q: 'Do you provide services in Jigani Bangalore?',
    a: 'Yes, we provide complete digital marketing services in Jigani and South Bangalore industrial belt.',
  },
  {
    q: 'Do you work with export companies?',
    a: 'Yes, we specialize in export and manufacturing marketing.',
  },
  {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="pt-[120px]">
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/25 bg-primary/[0.08] text-primary font-bold text-xs tracking-widest uppercase mb-5">
              ...
              Industrial & Export Growth Marketing by Veyber
            </span>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Jigani, Bangalore</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Looking for result-driven digital marketing services in Jigani, Bangalore?
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              At Veyber, we help manufacturing companies, industrial units, and export businesses in Jigani grow through SEO, performance marketing, and B2B lead generation systems designed for industrial markets. We focus on high-quality business inquiries, global visibility, and long-term growth.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate Export Markets</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Jigani Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Jigani is one of South Bangalore&apos;s rapidly expanding industrial zones, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'Manufacturing & engineering industries' },
                     { text: 'Pharma & chemical units' },
                     { text: 'Industrial estates & factories' },
                     { text: 'Export-oriented businesses' },
                     { text: 'Warehousing & logistics hubs' }
                  ].map(({ text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates strong B2B demand but low digital visibility for many companies. To grow here, you need: <span className="text-primary">Strong Google ranking for industrial keywords, precise B2B lead generation funnels, and a heavy export-focused digital strategy.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Jigani</h3>
        ...
        {/* Our Services in Jigani */}
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Jigani</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Custom digital frameworks engineered natively to channel global export and heavy manufacturing inquiries directly into your pipeline.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We engineer aggressive B2B mechanisms uniquely positioning Jigani-based pharmaceutical, biochemical, and fabrication plants at the peak of global export SEO visibility.</p>
                
                <div className="space-y-4 mb-8">
                  <ul className="space-y-4">
                    {[
                      'Strong industrial SEO expertise',
                      'Export + B2B lead generation systems',
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                  ...
                  <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Jigani & Nearby</h3>
                  <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                    Our digital footprints secure the deepest roots spanning the South Bangalore industrial corridor.
                  </p>
                  
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {['Jigani', 'Anekal', 'Bommasandra', 'Electronic City', 'Attibele', 'South Bangalore industrial corridor'].map((area) => (
                ...
                <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full">
                  ...
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {[
                      ...
                      { name: 'Bommasandra', url: '/digital-marketing-bommasandra' },
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-20 bg-surface-container-low">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-on-surface-variant text-sm mb-10 max-w-lg mx-auto">We systematically pull massive export/B2B query structures natively toward the Jigani chemical & manufacturing blocks.</p>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Vital insights regarding our capacity targeting heavy chemical, pharma, and global fabrication export hubs embedded in Jigani.</p>
            </div>
