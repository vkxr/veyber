...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Electronic City Bangalore | SEO & B2B Leads – Veyber',
  description: 'Looking for digital marketing services in Electronic City Bangalore? Veyber offers SEO, PPC, social media marketing & B2B lead generation services.',
  keywords: 'Digital marketing services Electronic City, SEO company Electronic City Bangalore, B2B marketing Electronic City, IT marketing Bangalore, SaaS marketing Electronic City, Lead generation services Bangalore, Corporate digital marketing Bangalore',
};
...
const pageSchema = {
  ...
  description: 'Digital marketing services in Electronic City Bangalore including SEO, PPC, social media marketing and B2B lead generation for IT companies.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Electronic City Bangalore?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we offer complete digital marketing services for IT and corporate businesses in Electronic City.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we specialize in SaaS, IT firms, and B2B companies.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we focus on high-quality B2B lead generation campaigns.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  {
    ...
    desc: 'Build scalable, enterprise-ready ecommerce platforms.',
    items: ['Shopify, WooCommerce & custom builds', 'Secure & scalable architecture', 'Conversion-optimized UI/UX'],
    href: '/ecommerce-development',
  },
  {
    icon: 'storefront',
    title: 'Ecommerce Account Management',
    desc: 'Maximize revenue from marketplaces.',
  ...
  },
  {
    ...
    desc: 'Build authority in the digital space.',
    items: ['LinkedIn, Instagram & Facebook campaigns', 'Corporate branding', 'Paid ads & remarketing'],
    href: '/social-media-handling',
  },
  {
    icon: 'edit_note',
    title: 'Content Marketing',
    desc: 'Drive organic leads & authority.',
  ...
  },
  {
    ...
    desc: 'Scale operations & marketing ROI.',
    items: ['Growth strategy consulting', 'Funnel optimization', 'Market positioning'],
    href: '/business-consulting',
  },
];

const process = [
  { n: '01', label: 'Business Analysis', desc: 'Identify your true potential and exact bottlenecks.' },
  { n: '02', label: 'Market Research', desc: 'Corporate & enterprise market mapping (Electronic City).' },
  ...
  { n: '05', label: 'Optimization & Scaling', desc: 'Refining data and scaling ROI aggressively.' },
];

const results = [
  { icon: 'contacts', stat: 'High-quality', label: 'B2B Leads' },
  { icon: 'stars', stat: 'Strong', label: 'Google Rankings' },
  { icon: 'people', stat: 'Increased', label: 'Brand Authority' },
...
const faqs = [
  {
    q: 'Do you provide services in Electronic City Bangalore?',
    a: 'Yes, we offer complete digital marketing services for IT and corporate businesses in Electronic City.',
  },
  {
    q: 'Do you work with SaaS and IT companies?',
    a: 'Yes, we specialize in SaaS, IT firms, and B2B companies.',
  },
  {
    q: 'Do you provide B2B lead generation?',
    a: 'Yes, we focus on high-quality B2B lead generation campaigns.',
  },
  {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="pt-[120px]">
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Electronic City, Bangalore</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Looking for expert digital marketing services in Electronic City, Bangalore?
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              At Veyber, we help IT companies, SaaS businesses, startups, and enterprises in Electronic City scale through performance marketing, SEO systems, and conversion-focused digital strategies. We don&apos;t just bring traffic—we build predictable lead and revenue systems.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate Electronic City</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Electronic City Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Electronic City is one of India&apos;s largest IT industrial zones, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'Tech parks & IT companies' },
                     { text: 'SaaS & product-based startups' },
                     { text: 'Corporate offices & BPOs' },
                     { text: 'High-value B2B clients' }
                  ].map(({ text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates high-budget, high-competition digital space. To win here, you need: <span className="text-primary">Strong search visibility, B2B lead generation systems, and performance marketing campaigns.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Electronic City</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 relative z-10 w-full">
                  {[
                    'IT companies & SaaS businesses',
                    'Corporate firms & BPOs',
        ...
        {/* Our Services in Electronic City */}
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Electronic City</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Robust digital strategies to empower Electronic City&apos;s enterprise & IT ecosystems.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We engineer aggressive, performance-driven campaigns matching Electronic City&apos;s highly competitive corporate paradigms directly.</p>
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                  ...
                  <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Electronic City & Nearby</h3>
                  <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                    We also serve all surrounding commercial business corridors scaling efficiently.
                  </p>
                  
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {['Electronic City', 'Bommasandra', 'HSR Layout', 'Sarjapur Road', 'Bannerghatta Road', 'South Bangalore Region'].map((area) => (
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Common insights regarding our local Electronic City operations.</p>
            </div>
          ...
          <div className="force-dark max-w-4xl mx-auto text-center relative z-10 bg-neutral-900 rounded-[2rem] sm:rounded-[3rem] border border-white/15 overflow-hidden">
            ...
            <div className="relative z-10 p-8 sm:p-12 md:p-16">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary font-bold text-xs tracking-widest uppercase mb-6">
                <span className="relative flex h-1.5 w-1.5 shrink-0"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"/><span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-primary"/></span>
                Let’s Grow Your Business in Electronic City
              </span>
              ...
              <p className="text-base sm:text-lg text-white/75 mb-8 max-w-xl mx-auto leading-relaxed drop-shadow">
                Contact Veyber today for expert digital marketing services in Electronic City.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
