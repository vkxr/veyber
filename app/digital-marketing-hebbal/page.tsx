...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Hebbal Bangalore | SEO & Local Leads – Veyber',
  description: 'Looking for digital marketing services in Hebbal Bangalore? Veyber offers SEO, social media marketing, ecommerce & business consulting services.',
  keywords: 'Digital marketing services Hebbal, SEO company Hebbal Bangalore, Marketing agency Hebbal, Local SEO Hebbal, Healthcare marketing Hebbal, Real estate marketing Bangalore, Business consultant Hebbal, North Bangalore marketing',
};
...
const pageSchema = {
  ...
  description: 'Digital marketing services in Hebbal Bangalore including SEO, social media marketing, ecommerce development and business consulting.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Hebbal Bangalore?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we provide complete digital marketing services in Hebbal and North Bangalore.',
      },
    },
    {
      '@type': 'Question',
      name: 'Do you work with hospitals and real estate?',
      acceptedAnswer: {
        '@type': 'Answer',
...
const services = [
  {
    ...
    desc: 'Build professional online stores.',
    items: ['Shopify, WooCommerce & custom solutions', 'Mobile-first design', 'Conversion-focused UX'],
    href: '/ecommerce-development',
  },
  {
    icon: 'storefront',
    title: 'Ecommerce Account Management',
    desc: 'Increase online revenue.',
    items: ['Amazon, Flipkart & Meesho management', 'Listing optimization', 'Sales growth strategy'],
    href: '/account-management',
  },
  {
    icon: 'share',
    title: 'Social Media Marketing',
    desc: 'Build strong local brand presence.',
    items: ['Instagram & Facebook management', 'Corporate branding content', 'Paid ad campaigns'],
    href: '/social-media-handling',
  },
  {
    icon: 'edit_note',
    title: 'Content Marketing',
    desc: 'Increase search visibility and authority.',
    items: ['SEO blogs & website content', 'Local keyword targeting', 'Authority building content'],
  ...
  },
  {
    ...
    items: ['Local market strategy', 'Funnel optimization', 'Branding & positioning'],
...
const process = [
  ...
  { n: '02', label: 'Hebbal Market Research', desc: 'Analyzing North Bangalore premium commercial zones.' },
  ...
  { n: '05', label: 'Continuous Optimization', desc: 'Refining data and extracting maximum scale.' },
];

const results = [
  { icon: 'contacts', stat: 'High-quality', label: 'Inquiries' },
  { icon: 'stars', stat: 'Strong', label: 'Google Rankings' },
  { icon: 'people', stat: 'Better', label: 'Brand Trust' },
  { icon: 'payments', stat: 'Increased', label: 'Conversions' },
  { icon: 'timeline', stat: 'Sustainable', label: 'Business Growth' },
];

const faqs = [
  {
    q: 'Do you provide services in Hebbal Bangalore?',
    a: 'Yes, we provide complete digital marketing services in Hebbal and North Bangalore.',
  },
  {
    q: 'Do you work with hospitals and real estate?',
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="pt-[120px]">
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/25 bg-primary/[0.08] text-primary font-bold text-xs tracking-widest uppercase mb-5">
              ...
              Premium Local Growth Marketing by Veyber
            </span>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Hebbal, Bangalore</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Looking for expert digital marketing services in Hebbal, Bangalore?
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              At Veyber, we help businesses in Hebbal grow through SEO, social media marketing, and performance-driven lead generation strategies designed for sustainable growth. We focus on visibility, trust, and consistent customer acquisition.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate North Bangalore</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Hebbal Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Hebbal is a rapidly developing premium zone in North Bangalore, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'IT parks & corporate offices' },
                     { text: 'Hospitals & healthcare services' },
                     { text: 'Luxury residential communities' },
                     { text: 'Real estate & consulting firms' }
                  ].map(({ text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates high-value but competitive digital demand. To grow here, you need: <span className="text-primary">Strong Google visibility, local SEO dominance, and established brand trust & authority.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Hebbal</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 relative z-10 w-full">
                  {[
                    ...
                    'Coaching institutes',
                    'Local premium service providers',
                  ].map((ind) => (
        ...
        {/* Our Services in Hebbal */}
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Hebbal</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Robust systems targeting Hebbal&apos;s healthcare, real estate, and rapid commercial sectors natively.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We engineer premium, performance-driven campaigns mapping entirely to the unique luxury and heavy-corporate demands located natively in Hebbal.</p>
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                  ...
                  <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Hebbal & Nearby</h3>
                  <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                    We maintain dominant search structures wrapping throughout the entire North Bangalore expansion corridor.
                  </p>
                  
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {['Hebbal', 'Manyata Tech Park', 'Nagawara', 'RT Nagar', 'Yelahanka', 'North Bangalore'].map((area) => (
                ...
                <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full">
                  ...
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {[
                      ...
                      { name: 'Outer Ring Road', url: '/digital-marketing-outer-ring-road' },
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-20 bg-surface-container-low">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-on-surface-variant text-sm mb-10 max-w-lg mx-auto">Scaling dominant traffic frameworks inside dense commercial zones converting direct local inquiries.</p>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Essential context connecting our SEO pipeline to Hebbal specifically.</p>
            </div>
