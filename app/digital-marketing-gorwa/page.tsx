...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Gorwa Vadodara | B2B SEO & Lead Generation – Veyber',
  description: 'Looking for digital marketing services in Gorwa Vadodara? Veyber offers ecommerce, social media marketing, content marketing & consulting services.',
  keywords: 'Digital marketing services Gorwa Vadodara, SEO services Gorwa Vadodara, B2B marketing Gorwa, Industrial marketing Vadodara, Lead generation services Gorwa, Digital agency Gorwa, Business consultant Gorwa',
};
...
const pageSchema = {
  ...
  address: {
    '@type': 'PostalAddress',
    addressLocality: 'Gorwa',
    addressRegion: 'Gujarat',
    addressCountry: 'India',
  },
  description: 'Digital marketing services in Gorwa Vadodara including ecommerce development, social media marketing, content marketing and business consulting.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Gorwa Vadodara?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we offer complete digital marketing services in Gorwa and nearby areas.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  {
    ...
    items: ['Shopify, WooCommerce & custom websites', 'B2B & B2C ecommerce solutions', 'Secure and scalable platforms'],
    href: '/ecommerce-development',
  },
  {
    icon: 'storefront',
    title: 'Ecommerce Account Management',
    desc: 'Boost your online sales performance.',
    items: ['Amazon, Flipkart & Meesho management', 'Product listing optimization', 'Sales growth strategies'],
    href: '/account-management',
  },
  {
    icon: 'share',
    title: 'Social Media Handling in Gorwa',
    desc: 'Build brand awareness and generate leads.',
    items: ['Instagram, Facebook & LinkedIn management', 'Content creation & posting', 'Paid advertising campaigns'],
    href: '/social-media-handling',
  },
  {
    icon: 'edit_note',
    title: 'Content Marketing',
    desc: 'Drive targeted traffic and conversions.',
    items: ['SEO blog writing', 'Website content', 'Industry-focused content strategy'],
    href: '/content-marketing',
  },
  {
    icon: 'psychology',
    title: 'Business Consulting',
    desc: 'Optimize and grow your business.',
    items: ['Business growth planning', 'Market research', 'Process improvement'],
    href: '/business-consulting',
  },
];

const process = [
  { n: '01', label: 'Business Analysis', desc: 'Deep dive into your business model and target audience.' },
  { n: '02', label: 'Local Market Research', desc: 'Gorwa-focused competitor analysis & research.' },
  { n: '03', label: 'Strategy Development', desc: 'Developing a localized roadmap tailored to goals.' },
  { n: '04', label: 'Execution', desc: 'Deploying high-impact B2B/B2C campaigns.' },
  { n: '05', label: 'Optimization', desc: 'Refining data and iteratively scaling performance.' },
];

const results = [
  { icon: 'contacts', stat: 'High-quality', label: 'B2B Leads' },
  { icon: 'visibility', stat: 'Increased', label: 'Local Visibility' },
  { icon: 'verified_user', stat: 'Better', label: 'Brand Authority' },
  { icon: 'dynamic_form', stat: 'More', label: 'Inquiries & Conversions' },
  { icon: 'trending_up', stat: 'Long-term', label: 'Growth' },
];

const faqs = [
  {
    q: 'Do you provide services in Gorwa Vadodara?',
    a: 'Yes, we offer complete digital marketing services in Gorwa and nearby areas.',
  },
  {
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/25 bg-primary/[0.08] text-primary font-bold text-xs tracking-widest uppercase mb-5">
              ...
              Industrial & Local Business Growth with Veyber
            </span>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Gorwa, Vadodara</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Looking for expert digital marketing services in Gorwa, Vadodara?
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              At Veyber, we help businesses in Gorwa build a strong online presence, generate high-quality leads, and grow revenue using result-driven digital marketing strategies. Whether you&apos;re a factory, service provider, or ecommerce business—we help you scale faster with targeted strategies.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate Gorwa</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Gorwa Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Gorwa is a strategically important industrial and residential area in Vadodara, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'Industrial zones & manufacturing units' },
                     { text: 'Oil & refinery-related businesses' },
                     { text: 'Local service providers' },
                     { text: 'Residential areas with growing demand' }
                  ].map(({ text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates strong B2B + B2C opportunities with high competition. To succeed, you need: <span className="text-primary">Strong Google visibility, lead-focused marketing, and professional online branding.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Gorwa</h3>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Gorwa</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Result-driven strategies built specifically for the local industrial and retail markets.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We deploy customized strategies balancing industrial growth with local retail demands effectively.</p>
                
                <div className="space-y-4 mb-8">
                  <ul className="space-y-4">
                    {[
                      'Expertise in industrial & local marketing',
                      'Local knowledge of Vadodara',
                      'Customized strategies for Gorwa businesses',
                      'Affordable pricing',
              ...
              <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                ...
                <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Gorwa & Nearby Areas</h3>
                <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                  We are deeply integrated into the local map, serving primary residential and industrial zones optimally.
                </p>
                
                <div className="flex flex-wrap gap-2 mb-6 relative z-10">
                  {['Gorwa', 'Chhani', 'Nizampura', 'Sama', 'Nearby areas of Vadodara'].map((area) => (
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm">A structured execution roadmap to deliver maximum B2B and B2C value.</p>
            </div>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Common insights regarding our local Gorwa operations.</p>
            </div>
