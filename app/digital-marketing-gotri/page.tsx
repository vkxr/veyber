...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Gotri Vadodara | SEO, SMM, Ecommerce – Veyber',
  description: 'Looking for digital marketing services in Gotri Vadodara? Veyber offers ecommerce, social media marketing, content marketing & consulting services.',
  keywords: 'Digital marketing services Gotri Vadodara, Social media marketing Gotri, Ecommerce development Gotri, SEO services Gotri Vadodara, Digital agency Gotri, Marketing company Vadodara, Business consultant Gotri',
};
...
const pageSchema = {
  ...
  description: 'Digital marketing services in Gotri Vadodara including ecommerce development, social media marketing, content marketing and business consulting.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Gotri Vadodara?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we offer complete digital marketing services in Gotri and nearby areas.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we specialize in helping startups and growing businesses scale online.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  {
    ...
    desc: 'Build an online store that converts.',
    items: ['Shopify, WooCommerce & custom websites', 'Mobile-friendly & SEO-optimized', 'Fast, secure, and scalable'],
    href: '/ecommerce-development',
  },
  {
    icon: 'storefront',
    title: 'Ecommerce Account Management',
    desc: 'Grow your online marketplace sales.',
    items: ['Amazon, Flipkart & Meesho management', 'Product listing optimization', 'Sales growth strategies'],
    href: '/account-management',
  },
  {
    icon: 'share',
    title: 'Social Media Handling in Gotri',
    desc: 'Engage your audience and build brand awareness.',
...
const process = [
  ...
  { n: '02', label: 'Local Market Analysis', desc: 'Gotri-focused audience alignment and targeting.' },
...
const results = [
  ...
  { icon: 'dynamic_form', stat: 'More', label: 'Quality Leads' },
...
const faqs = [
  {
    q: 'Do you provide services in Gotri Vadodara?',
    a: 'Yes, we offer complete digital marketing services in Gotri and nearby areas.',
  },
  {
    q: 'Can you help growing businesses?',
    a: 'Yes, we specialize in helping startups and growing businesses scale online.',
  },
  {
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Gotri, Vadodara</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Grow Your Business with Veyber – Local Experts in Gotri
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              Looking for professional digital marketing services in Gotri, Vadodara? At Veyber, we help businesses in Gotri build a powerful online presence, attract local customers, and increase revenue through data-driven digital strategies. Whether you run a premium service, startup, or ecommerce brand—we help you scale efficiently and sustainably.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate Gotri</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Gotri Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Gotri is one of the most rapidly developing and premium residential areas in Vadodara, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'Modern residential societies' },
                     { text: 'Clinics & healthcare services' },
                     { text: 'Retail businesses' },
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates high growth potential + increasing competition. To stand out, you need: <span className="text-primary">Strong Google visibility, active social media presence, and consistent branding.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Gotri</h3>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Gotri</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Data-driven digital strategies to help you scale efficiently and sustainably.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We deploy customized strategies for fast-growing areas like Gotri, delivering maximum value with dedicated support.</p>
                
                <div className="space-y-4 mb-8">
                  <ul className="space-y-4">
                    {[
                      'Local expertise in Vadodara',
                      'Customized strategies for growing areas like Gotri',
                      'Affordable pricing',
                      'Dedicated support',
              ...
              <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                ...
                <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Gotri & Nearby Areas</h3>
                ...
                <div className="flex flex-wrap gap-2 mb-6 relative z-10">
                  {['Gotri', 'Subhanpura', 'Nizampura', 'Akota', 'Nearby areas of Vadodara'].map((area) => (
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Common insights regarding our local Gotri operations.</p>
            </div>
          ...
          <div className="force-dark max-w-4xl mx-auto text-center relative z-10 bg-neutral-900 rounded-[2rem] sm:rounded-[3rem] border border-white/15 overflow-hidden">
            ...
            <div className="relative z-10 p-8 sm:p-12 md:p-16">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary font-bold text-xs tracking-widest uppercase mb-6">
                <span className="relative flex h-1.5 w-1.5 shrink-0"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"/><span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-primary"/></span>
                Let’s Grow Your Business in Gotri
              </span>
              ...
              <p className="text-base sm:text-lg text-white/75 mb-8 max-w-xl mx-auto leading-relaxed drop-shadow">
                Contact Veyber today for expert digital marketing services in Gotri.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
