...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Manjalpur Vadodara | SEO, SMM, Ecommerce – Veyber',
  description: 'Looking for digital marketing services in Manjalpur Vadodara? Veyber offers ecommerce, social media marketing, content marketing & consulting services.',
  keywords: 'Digital marketing services Manjalpur Vadodara, Social media marketing Manjalpur, Ecommerce development Manjalpur, SEO services Manjalpur Vadodara, Digital agency Manjalpur, Marketing company Vadodara, Business consultant Manjalpur',
};
...
const pageSchema = {
  ...
  address: {
    '@type': 'PostalAddress',
    addressLocality: 'Manjalpur',
    addressRegion: 'Gujarat',
    addressCountry: 'India',
  },
  description: 'Digital marketing services in Manjalpur Vadodara including ecommerce development, social media marketing, content marketing and business consulting.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Manjalpur Vadodara?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we offer complete digital marketing services in Manjalpur and nearby areas.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  {
    ...
    desc: 'Expand your business online and increase sales.',
    items: ['Shopify, WooCommerce & custom ecommerce websites', 'Mobile-friendly & SEO-optimized', 'Fast, secure, and scalable'],
  ...
  {
    icon: 'share',
    title: 'Social Media Handling in Manjalpur',
  ...
  },
  {
    ...
    desc: 'Rank higher and attract more customers.',
...
const process = [
  ...
  { n: '02', label: 'Local Market Analysis', desc: 'Manjalpur-focused audience alignment and targeting.' },
...
const results = [
  { icon: 'visibility', stat: 'High', label: 'Local Visibility' },
  { icon: 'dynamic_form', stat: 'Increased', label: 'Inquiries & Leads' },
...
const faqs = [
  {
    q: 'Do you provide services in Manjalpur Vadodara?',
    a: 'Yes, we offer complete digital marketing services in Manjalpur and nearby areas.',
  },
  {
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Manjalpur, Vadodara</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Grow Your Business with Veyber – Local Experts in Manjalpur
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              Looking for professional digital marketing services in Manjalpur, Vadodara? At Veyber, we help businesses in Manjalpur build a strong online presence, attract local customers, and increase sales through data-driven digital strategies. Whether you&apos;re a local shop, service provider, startup, or ecommerce business—we help you grow faster and dominate your local market.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate Manjalpur</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Manjalpur Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Manjalpur is one of the most densely populated and commercially active areas in Vadodara, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'Local markets & retail shops' },
                     { text: 'Clinics & service providers' },
                     { text: 'Small & medium businesses' },
                     { text: 'High residential density' }
                  ].map(({ text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates very high search demand + strong competition. To succeed, you need: <span className="text-primary">Top ranking on Google, a strong social media presence, and consistent online visibility.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Manjalpur</h3>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Manjalpur</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Data-driven digital strategies to help you grow faster and dominate your local market.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We deploy customized strategies for high-demand areas like Manjalpur, delivering maximum value with dedicated support.</p>
                
                <div className="space-y-4 mb-8">
                  <ul className="space-y-4">
                    {[
                      'Local expertise in Vadodara',
                      'Customized strategies for high-demand areas like Manjalpur',
                      'Affordable pricing',
                      'Dedicated support',
              ...
              <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                ...
                <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Manjalpur & Nearby Areas</h3>
                ...
                <div className="flex flex-wrap gap-2 mb-6 relative z-10">
                  {['Manjalpur', 'Tarsali', 'Makarpura', 'Waghodia Road', 'Nearby areas of Vadodara'].map((area) => (
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Common insights regarding our local Manjalpur operations.</p>
            </div>
          ...
          <div className="force-dark max-w-4xl mx-auto text-center relative z-10 bg-neutral-900 rounded-[2rem] sm:rounded-[3rem] border border-white/15 overflow-hidden">
            ...
            <div className="relative z-10 p-8 sm:p-12 md:p-16">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary font-bold text-xs tracking-widest uppercase mb-6">
                <span className="relative flex h-1.5 w-1.5 shrink-0"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"/><span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-primary"/></span>
                Let’s Grow Your Business in Manjalpur
              </span>
              ...
              <p className="text-base sm:text-lg text-white/75 mb-8 max-w-xl mx-auto leading-relaxed drop-shadow">
                Contact Veyber today for expert digital marketing services in Manjalpur.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
