...
<div className="absolute -top-24 -right-24 w-96 h-96 bg-primary/10 blur-[80px] rounded-full"></div>
...
<div className="w-12 h-12 rounded-xl bg-white/15 flex items-center justify-center mb-6 border border-white/20">
...
<span className="px-3 py-1 bg-white/15 rounded-full text-[10px] uppercase tracking-widest text-white font-bold border border-white/20">Community Management</span>
<span className="px-3 py-1 bg-white/15 rounded-full text-[10px] uppercase tracking-widest text-white font-bold border border-white/20">Paid Social Ads</span>
</div>
...
{/* Right column — key outcome stats */}
...
<Link href="/contact" className="inline-flex items-center bg-white/10 hover:bg-white/20 px-6 sm:px-8 py-3 sm:py-4 rounded-full text-white font-bold transition-all border border-white/20 cursor-pointer">
...
{/* Live badge */}
<span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/25 bg-white/10 text-white font-bold text-xs tracking-widest uppercase mb-8 shadow-[0_0_20px_rgba(255,255,255,0.08)]">
