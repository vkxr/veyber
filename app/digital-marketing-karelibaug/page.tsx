...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Karelibaug Vadodara | SEO, SMM, Ecommerce – Veyber',
  description: 'Looking for digital marketing services in Karelibaug Vadodara? Veyber offers ecommerce development, social media marketing, content marketing & consulting services.',
  keywords: 'Digital marketing services Karelibaug Vadodara, Social media marketing Karelibaug, Ecommerce development Karelibaug, SEO services Karelibaug Vadodara, Digital agency Karelibaug, Marketing company Vadodara, Business consultant Karelibaug',
};
...
const pageSchema = {
  ...
  description: 'Digital marketing services in Karelibaug Vadodara including ecommerce development, social media marketing, content marketing and business consulting.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Karelibaug Vadodara?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we offer complete digital marketing services in Karelibaug and nearby areas.',
      },
    },
    {
      '@type': 'Question',
      name: 'Can you help small businesses grow?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we specialize in helping local businesses and SMEs grow online.',
      },
    },
    {
      '@type': 'Question',
      name: 'Do you provide social media services?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we manage Instagram, Facebook, and other platforms.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  {
    ...
    desc: 'Take your business online and expand your reach.',
    items: ['Shopify, WooCommerce & custom websites', 'Mobile-friendly & SEO-optimized', 'Secure and fast performance'],
    href: '/ecommerce-development',
  },
  {
    icon: 'storefront',
    title: 'Ecommerce Account Management',
    desc: 'Boost your marketplace sales.',
    items: ['Amazon, Flipkart & Meesho management', 'Product listing optimization', 'Sales growth strategies'],
    href: '/account-management',
  },
  {
    icon: 'share',
    title: 'Social Media Handling in Karelibaug',
    desc: 'Engage local customers and build your brand.',
  ...
  },
  {
    ...
    desc: 'Rank on Google and attract more customers.',
  ...
  },
  {
    ...
    desc: 'Grow your business with expert strategies.',
...
const process = [
  { n: '01', label: 'Business Analysis', desc: 'Understanding your unique business model and goals.' },
  { n: '02', label: 'Local Market Research', desc: 'Karelibaug-focused targeting to ensure maximum local penetration.' },
  ...
  { n: '05', label: 'Optimization', desc: 'Monitoring metrics and refining tactics for sustainable growth.' },
];
...
const results = [
  ...
  { icon: 'timeline', stat: 'Sustainable', label: 'Growth' },
];

const faqs = [
  {
    q: 'Do you provide services in Karelibaug Vadodara?',
    a: 'Yes, we offer complete digital marketing services in Karelibaug and nearby areas.',
  },
  {
    q: 'Can you help small businesses grow?',
    a: 'Yes, we specialize in helping local businesses and SMEs grow online.',
  },
  {
    q: 'Do you provide social media services?',
    a: 'Yes, we manage Instagram, Facebook, and other platforms.',
  },
  {
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Karelibaug, Vadodara</span>
            </h1>
            ...
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              Looking for expert digital marketing services in Karelibaug, Vadodara? At Veyber, we help businesses in Karelibaug build strong online visibility, attract local customers, and increase sales through result-driven digital strategies. Whether you run a local shop, service business, or ecommerce brand—we help you stand out and grow.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate Karelibaug</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Karelibaug Businesses Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Karelibaug is one of the most active residential and commercial areas in Vadodara, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'Local businesses & shops' },
                     { text: 'Clinics & service providers' },
                     { text: 'Retail stores & Small/medium enterprises' },
                  ].map(({ text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates high competition in local search. To succeed, you need: <span className="text-primary">Strong Google visibility, active social media, and consistent engagement.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Karelibaug</h3>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Karelibaug</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Result-driven digital strategies to help you stand out and grow in your local market.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We deploy customized strategies for Karelibaug businesses, delivering maximum value with dedicated support.</p>
                
                <div className="space-y-4 mb-8">
                  <ul className="space-y-4">
                    {[
                      'Local expertise in Vadodara',
                      'Customized strategies for Karelibaug businesses',
                      'Affordable pricing',
                      'Dedicated support',
              ...
              <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                ...
                <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Karelibaug & Nearby Areas</h3>
                <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                  We are deeply integrated into the local grid, serving primary commercial zones seamlessly.
                </p>
                
                <div className="flex flex-wrap gap-2 mb-6 relative z-10">
                  {['Karelibaug', 'Fatehgunj', 'Sayajigunj', 'Nizampura', 'Nearby areas of Vadodara'].map((area) => (
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Common insights regarding our local Karelibaug operations.</p>
            </div>
          ...
          <div className="force-dark max-w-4xl mx-auto text-center relative z-10 bg-neutral-900 rounded-[2rem] sm:rounded-[3rem] border border-white/15 overflow-hidden">
            ...
            <div className="relative z-10 p-8 sm:p-12 md:p-16">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary font-bold text-xs tracking-widest uppercase mb-6">
                <span className="relative flex h-1.5 w-1.5 shrink-0"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"/><span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-primary"/></span>
                Let’s Grow Your Business in Karelibaug
              </span>
              ...
              <p className="text-base sm:text-lg text-white/75 mb-8 max-w-xl mx-auto leading-relaxed drop-shadow">
                Contact Veyber today for expert digital marketing services in Karelibaug.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
