...
export const metadata: Metadata = {
  title: 'Digital Marketing Services Near Manyata Tech Park Bangalore | IT & SaaS Leads – Veyber',
  description: 'Looking for digital marketing services near Manyata Tech Park Bangalore? Veyber offers SEO, PPC, social media marketing & B2B lead generation for IT companies.',
  keywords: 'Digital marketing services Manyata Tech Park, SEO company Nagawara Bangalore, IT marketing Manyata Tech Park, SaaS marketing Bangalore North, B2B lead generation Bangalore, Corporate marketing Nagawara, Performance marketing Bangalore, IT company marketing Bangalore',
};
...
const pageSchema = {
  ...
  areaServed: {
    '@type': 'Place',
    name: 'Manyata Tech Park, Nagawara, Bangalore',
  },
  address: {
    '@type': 'PostalAddress',
  ...
  description: 'Digital marketing services near Manyata Tech Park Bangalore including SEO, PPC, social media marketing and B2B lead generation for IT and SaaS companies.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services near Manyata Tech Park?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we provide complete digital marketing services for IT companies in and around Manyata Tech Park.',
      },
    },
    {
      '@type': 'Question',
      name: 'Do you work with MNCs and SaaS companies?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we specialize in enterprise, SaaS, and IT companies.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we focus on high-quality B2B lead generation systems.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  {
    ...
    desc: 'Enterprise-grade digital commerce systems.',
    items: ['Shopify, WooCommerce & custom platforms', 'Scalable architecture', 'Conversion-focused UI/UX'],
    href: '/ecommerce-development',
  },
  {
    icon: 'storefront',
    title: 'Ecommerce Account Management',
    desc: 'Marketplace revenue scaling.',
    items: ['Amazon, Flipkart & Meesho management', 'Listing optimization & ads', 'Performance scaling strategies'],
    href: '/account-management',
  },
  {
    icon: 'share',
    title: 'Social Media Marketing',
    desc: 'Corporate brand positioning.',
    items: ['LinkedIn + Instagram campaigns', 'Thought leadership content', 'Paid ads & retargeting'],
    href: '/social-media-handling',
  },
  {
    icon: 'edit_note',
    title: 'Content Marketing',
    desc: 'Authority building for IT companies.',
    items: ['SEO blogs & landing pages', 'B2B content funnels', 'Technical + business content'],
    href: '/content-marketing',
  },
  {
    icon: 'psychology',
    title: 'Business Consulting',
    desc: 'Growth system design.',
    items: ['GTM strategy (Go-To-Market)', 'Funnel optimization', 'Market positioning for SaaS & IT firms'],
    href: '/business-consulting',
  },
];

const process = [
  { n: '01', label: 'Corporate Business Analysis', desc: 'Identify your true potential and precise bottlenecks.' },
  { n: '02', label: 'IT Corridor Research', desc: 'Detailed mapping of the Manyata ecosystem.' },
  { n: '03', label: 'Strategy Development', desc: 'Developing bespoke conversion-focused action plans.' },
  { n: '04', label: 'Execution', desc: 'Rolling out highly optimized multi-channel campaigns.' },
  { n: '05', label: 'Continuous Optimization', desc: 'Refining data and scaling performance.' },
];

const results = [
  { icon: 'contacts', stat: 'High-quality', label: 'B2B Leads' },
  { icon: 'stars', stat: 'Strong', label: 'Corporate Visibility' },
  { icon: 'people', stat: 'Predictable', label: 'Sales Pipeline' },
  { icon: 'payments', stat: 'Improved', label: 'Brand Authority' },
  { icon: 'timeline', stat: 'Scalable', label: 'Marketing Systems' },
];

const faqs = [
  {
    q: 'Do you provide services near Manyata Tech Park?',
    a: 'Yes, we provide complete digital marketing services for IT companies in and around Manyata Tech Park.',
  },
  {
    q: 'Do you work with MNCs and SaaS companies?',
    a: 'Yes, we specialize in enterprise, SaaS, and IT companies.',
  },
  {
    q: 'Do you provide B2B lead generation?',
    a: 'Yes, we focus on high-quality B2B lead generation systems.',
  },
  {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="pt-[120px]">
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/25 bg-primary/[0.08] text-primary font-bold text-xs tracking-widest uppercase mb-5">
              ...
              Enterprise & IT Growth Marketing by Veyber
            </span>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>Near Manyata Tech Park, Bangalore</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Looking for premium digital marketing services near Manyata Tech Park, Nagawara, Bangalore?
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              At Veyber, we help IT companies, SaaS businesses, and corporate teams inside and around Manyata Tech Park scale through performance marketing, SEO systems, and B2B lead generation strategies. We focus on predictable growth, not random traffic.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate the North Corridor</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Manyata Tech Park Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Manyata Tech Park is one of Bangalore&apos;s largest IT hubs, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'MNC offices & global companies' },
                     { text: 'SaaS & product engineering teams' },
                     { text: 'IT services firms' },
                     { text: 'High-budget corporate decision-making' }
                  ].map(({ text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates high-value but highly competitive digital acquisition space. To win here, you need: <span className="text-primary">Strong Google visibility for B2B keywords, lead generation funnels, and performance marketing systems.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Manyata Tech Park</h3>
        ...
        {/* Our Services in Manyata Tech Park */}
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Manyata Tech Park</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Powerful digital systems tailored for the corporate demands of Nagawara and North Bangalore.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We engineer aggressive, performance-driven campaigns directly aligning with the high-stakes, high-budget scale of Manyata Tech Park corporate acquisitions.</p>
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                  ...
                  <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Manyata Tech Park & Nearby</h3>
                  <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                    We deploy localized targeting across all North Bangalore commercial zones heavily concentrated near the park.
                  </p>
                  
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {['Manyata Tech Park', 'Nagawara', 'Hebbal', 'Thanisandra', 'ORR North Corridor', 'North Bangalore Tech Zone'].map((area) => (
                ...
                <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full">
                  ...
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {[
                      ...
                      { name: 'Outer Ring Road (ORR)', url: '/digital-marketing-outer-ring-road' },
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm">A highly structured operational roadmap.</p>
            </div>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-20 bg-surface-container-low">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-on-surface-variant text-sm mb-10 max-w-lg mx-auto">Dominating Northern Bangalore&apos;s corporate sprawl by heavily targeting established commercial intent.</p>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Essential context regarding our deployments in and around Manyata Tech Park.</p>
            </div>
          ...
          <div className="force-dark max-w-4xl mx-auto text-center relative z-10 bg-neutral-900 rounded-[2rem] sm:rounded-[3rem] border border-white/15 overflow-hidden">
            ...
            <div className="relative z-10 p-8 sm:p-12 md:p-16">
              ...
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-white mb-4 tracking-tight drop-shadow-xl">
                Ready to scale your IT or SaaS business?
              </h2>
              <p className="text-base sm:text-lg text-white/75 mb-8 max-w-xl mx-auto leading-relaxed drop-shadow">
                Contact Veyber for expert digital marketing services near Manyata Tech Park, Bangalore.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
