        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[{"n":"01","label":"Audit & Strategy","desc":"We analyze your current presence, competitors, and target audience to build a customized roadmap."},{"n":"02","label":"Campaign Setup","desc":"From fixing technical SEO issues to setting up advanced ad tracking and audience segments."},{"n":"03","label":"Execution & Launch","desc":"Deploying high-quality content, launching optimized ad campaigns, and managing daily performance."},{"n":"04","label":"Tracking & Analytics","desc":"We monitor every click, conversion, and keyword ranking using advanced analytics."},{"n":"05","label":"Optimization","desc":"Continuous A/B testing, bid adjustments, and content updates to maximize ROI."},{"n":"06","label":"Scaling","desc":"Once we find the winning formula, we scale the campaigns to drive exponential growth."}].map((step: any, i: number) => (
