...
{/*  Hero Section  */}
<header className="relative px-8 mb-24 max-w-7xl mx-auto overflow-hidden">
<div className="absolute -top-24 -right-24 w-96 h-96 bg-primary/10 blur-[120px] rounded-full"></div>
<div className="relative z-10 max-w-3xl">
<span className="text-primary font-headline font-bold tracking-widest uppercase text-xs mb-4 block">Elevate Your Presence</span>
<h1 className="text-5xl md:text-7xl font-headline font-extrabold tracking-tight text-white mb-6 leading-[1.1]">
...
<div id="ecommerce-dev" className="force-dark lg:col-span-7 group relative bg-neutral-900 rounded-2xl transition-all hover:-translate-y-1 overflow-hidden min-h-[420px] flex flex-col">
...
<div id="account-management" className="force-dark lg:col-span-5 group relative bg-neutral-900 rounded-2xl transition-all hover:-translate-y-1 overflow-hidden min-h-[420px] flex flex-col">
...
{/*  Social Media & Content Marketing - Split  */}
<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
{/*  Social Media Handling  */}
<div id="social-media" className="force-dark relative rounded-2xl overflow-hidden min-h-[420px] flex items-end group">
{/* Background — vibrant social media / community engagement */}
<img
  className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
  alt="Social Media Handling — phone with social media apps"
  src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?auto=format&fit=crop&w=900&q=85"
/>
...
{/*  Content Marketing  */}
<div id="content-marketing" className="force-dark relative bg-neutral-900 rounded-2xl overflow-hidden flex flex-col justify-between group border-l-4 border-primary min-h-[420px]">
...
<h3 className="text-3xl font-headline font-bold text-white mb-6">Business Consulting</h3>
<p className="text-white/70 text-lg leading-relaxed mb-8">High-level strategic planning to help businesses navigate the complexities of digital transformation and scaling.</p>
...
<div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/15 flex flex-col gap-2">
...
<div className="mt-10">
<Link href="/contact" className="inline-flex items-center bg-white/10 hover:bg-white/20 backdrop-blur-sm px-8 py-4 rounded-full text-white font-bold transition-all border border-white/20 cursor-pointer">
...
{/*  CTA Section  */}
<section className="mt-12 px-8 max-w-7xl mx-auto pb-8">
...
<h2 className="text-4xl md:text-5xl font-headline font-extrabold text-white mb-5 leading-tight tracking-tight">
...
<div className="relative inline-block mb-5">
  ...
  <Link href="/contact" className="relative group inline-flex items-center bg-white text-[#111225] px-12 py-5 rounded-full font-headline font-bold text-lg shadow-[0_8px_32px_rgba(255,255,255,0.25)] hover:shadow-[0_8px_48px_rgba(255,255,255,0.40)] transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer">
