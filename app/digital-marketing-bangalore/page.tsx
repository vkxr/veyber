...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Bangalore | SEO, SMM, Ecommerce – Veyber',
  description: 'Looking for digital marketing services in Bangalore? Veyber offers SEO, ecommerce, social media marketing & business consulting services.',
  keywords: 'Digital marketing services Bangalore, SEO company Bangalore, Digital marketing agency Bangalore, Ecommerce marketing Bangalore, Social media marketing Bangalore, Business consultant Bangalore, Marketing agency Bangalore',
};
...
const pageSchema = {
  ...
  description: 'Digital marketing services in Bangalore including ecommerce development, SEO, social media marketing and business consulting.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Bangalore?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we offer digital marketing services across Bangalore.',
      },
    },
    {
      '@type': 'Question',
      name: 'Can you help startups grow?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we specialize in startup and growth-stage business marketing.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we offer ROI-driven campaigns and lead generation strategies.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  {
    ...
    desc: 'Build scalable ecommerce platforms.',
    items: ['Shopify, WooCommerce & custom solutions', 'High-performance & mobile-optimized', 'Conversion-focused design'],
  ...
  },
  {
    ...
    items: ['Amazon, Flipkart & Meesho management', 'Advanced listing optimization', 'Sales growth strategies'],
    href: '/account-management',
  },
  {
    icon: 'share',
    title: 'Social Media Marketing',
    desc: 'Build a powerful brand presence.',
    items: ['Instagram, Facebook & LinkedIn management', 'Content creation & campaigns', 'Paid advertising'],
  ...
  },
  {
    ...
    desc: 'Scale your business with expert strategies.',
    items: ['Growth planning', 'Market positioning', 'Process optimization'],
    href: '/business-consulting',
  },
];

const process = [
  { n: '01', label: 'Business Analysis', desc: 'Identify your true potential and precise bottlenecks.' },
  { n: '02', label: 'Market Research', desc: 'Bangalore-focused audience alignment and targeting.' },
  { n: '03', label: 'Strategy Development', desc: 'Developing bespoke action plans and timeline scaling.' },
...
const results = [
  { icon: 'visibility', stat: 'Increased', label: 'Online Visibility' },
  ...
  { icon: 'timeline', stat: 'Scalable', label: 'Growth' },
];

const faqs = [
  {
    q: 'Do you provide services in Bangalore?',
    a: 'Yes, we offer digital marketing services across Bangalore.',
  },
  {
    q: 'Can you help startups grow?',
    a: 'Yes, we specialize in startup and growth-stage business marketing.',
  },
  {
    q: 'Do you provide performance marketing?',
    a: 'Yes, we offer ROI-driven campaigns and lead generation strategies.',
  },
  {
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/25 bg-primary/[0.08] text-primary font-bold text-xs tracking-widest uppercase mb-5">
              ...
              Scale Your Business with Veyber
            </span>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Bangalore, Karnataka</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Looking for expert digital marketing services in Bangalore, Karnataka?
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              At Veyber, we help startups, SMEs, and growing brands in Bangalore scale faster with data-driven marketing strategies, performance campaigns, and scalable growth systems. From lead generation to brand building—we focus on real business outcomes, not just vanity metrics.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate Bangalore</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Bangalore Need Advanced Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Bangalore is India&apos;s leading tech and startup hub, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'IT companies & SaaS startups' },
                     { text: 'Ecommerce brands' },
                     { text: 'Funded startups' },
                     { text: 'Highly competitive digital space' }
                  ].map(({ text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates extreme competition + massive growth potential. To succeed in Bangalore, you need: <span className="text-primary">Strong SEO + performance marketing, high-conversion funnels, and consistent digital presence.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Bangalore</h3>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Bangalore</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Robust digital strategies to empower Bangalore&apos;s rapidly scaling startup sectors.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We engineer aggressive, performance-driven campaigns matching Bangalore&apos;s fast-paced tech environment.</p>
                ...
                <div className="space-y-4 mb-8">
                  <ul className="space-y-4">
                    {[
                      ...
                      'Affordable solutions compared to metro agencies',
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                  ...
                  <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Bangalore & Nearby Areas</h3>
                  <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                    We serve all major areas of Bangalore, integrating into highly competitive tech zones seamlessly.
                  </p>
                  ...
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {['BTM Layout', 'Rajajinagar', 'Whitefield', 'Electronic City', 'Indiranagar', 'Koramangala', 'HSR Layout', 'Marathahalli', 'Sarjapur Road', 'Bellandur', 'Jayanagar', 'J.P. Nagar', 'Outer Ring Road', 'Manyata Tech Park', 'Brookefield', 'Kadubeesanahalli', 'Hebbal', 'Yelahanka', 'KR Puram', 'Banashankari', 'Basavanagudi', 'Malleshwaram', 'Vijayanagar', 'Nagarbhavi', 'Devanahalli', 'Hoskote', 'Kanakapura Road', 'Bannerghatta Road', 'Thanisandra', 'Kengeri', 'Attibele', 'MG Road', 'Brigade Road', 'Shivajinagar', 'Commercial Street', 'Richmond Town', 'Lavelle Road', 'Peenya', 'Bommasandra', 'Bidadi', 'Jigani', 'Nelamangala', 'Ulsoor'].map((area) => {
                      const activeLinks: Record<string, string> = {
                        ...
                        'Whitefield': '/digital-marketing-whitefield',
                        'Sarjapur Road': '/digital-marketing-sarjapur-road',
                        'Bellandur': '/digital-marketing-bellandur',
                        'Marathahalli': '/digital-marketing-marathahalli',
                        'Jayanagar': '/digital-marketing-jayanagar',
                        'J.P. Nagar': '/digital-marketing-jp-nagar',
                        'Electronic City': '/digital-marketing-electronic-city',
                        'Outer Ring Road': '/digital-marketing-outer-ring-road',
                        'Manyata Tech Park': '/digital-marketing-manyata-tech-park',
                        'Brookefield': '/digital-marketing-brookefield',
                        'Kadubeesanahalli': '/digital-marketing-kadubeesanahalli',
                        'Hebbal': '/digital-marketing-hebbal',
                        'Yelahanka': '/digital-marketing-yelahanka',
                        'KR Puram': '/digital-marketing-kr-puram',
                        'Banashankari': '/digital-marketing-banashankari',
                        'Basavanagudi': '/digital-marketing-basavanagudi',
                        'Malleshwaram': '/digital-marketing-malleshwaram',
                        'Vijayanagar': '/digital-marketing-vijayanagar',
                        'Nagarbhavi': '/digital-marketing-nagarbhavi',
                        'Devanahalli': '/digital-marketing-devanahalli',
                        'Hoskote': '/digital-marketing-hoskote',
                        'Kanakapura Road': '/digital-marketing-kanakapura-road',
                        'Bannerghatta Road': '/digital-marketing-bannerghatta-road',
                        'Thanisandra': '/digital-marketing-thanisandra',
                        'Kengeri': '/digital-marketing-kengeri',
                        'Attibele': '/digital-marketing-attibele',
                        'MG Road': '/digital-marketing-mg-road',
                        'Brigade Road': '/digital-marketing-brigade-road',
                        'Shivajinagar': '/digital-marketing-shivajinagar',
                        'Commercial Street': '/digital-marketing-commercial-street',
                        'Richmond Town': '/digital-marketing-richmond-town',
                        'Lavelle Road': '/digital-marketing-lavelle-road',
                        'Peenya': '/digital-marketing-peenya',
                        'Bommasandra': '/digital-marketing-bommasandra',
                        'Bidadi': '/digital-marketing-bidadi',
                        'Jigani': '/digital-marketing-jigani',
                        'Nelamangala': '/digital-marketing-nelamangala',
                        'Ulsoor': '/digital-marketing-ulsoor',
                      };
                      const link = activeLinks[area];
                      
                      return link ? (
                        <Link key={area} href={link} className="px-3 py-1.5 bg-surface-container-high text-xs font-semibold text-white/80 rounded-md border border-outline-variant/10 flex items-center gap-1.5 hover:border-primary/50 hover:text-primary transition-colors cursor-pointer group">
                ...
                <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full">
                  <h3 className="text-lg font-bold font-headline mb-4 text-white">Major Cities & States We Serve</h3>
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {[
                      { name: 'Karnataka', url: '/digital-marketing-karnataka' },
                      { name: 'Gujarat', url: '/digital-marketing-gujarat' },
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm">A structured execution roadmap to deliver maximum growth.</p>
            </div>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Common insights regarding our local Bangalore operations.</p>
            </div>
