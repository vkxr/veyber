...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Surat | SEO, SMM, Ecommerce – Veyber',
  description: 'Looking for digital marketing services in Surat? Veyber offers SEO, ecommerce, social media marketing & business consulting services.',
  keywords: 'Digital marketing services Surat, SEO company Surat, Ecommerce marketing Surat, Social media marketing Surat, Digital marketing agency Gujarat, Business consultant Surat, Marketing company Surat',
};
...
const pageSchema = {
  ...
  description: 'Digital marketing services in Surat Gujarat including ecommerce development, SEO, social media marketing and business consulting.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Surat?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we offer complete digital marketing services across Surat.',
      },
    },
    {
      '@type': 'Question',
      name: 'Can you help ecommerce businesses grow?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we specialize in ecommerce growth and marketplace management.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we offer SEO, social media, and performance marketing.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  {
    ...
    items: ['Shopify, WooCommerce & custom solutions', 'Conversion-focused design', 'Mobile-optimized & secure'],
  ...
  },
  {
    ...
    items: ['Amazon, Flipkart & Meesho management', 'Product listing optimization', 'Growth-focused strategies'],
    href: '/account-management',
  },
  {
    icon: 'share',
    title: 'Social Media Marketing',
    desc: 'Build your brand and reach your audience.',
  ...
  },
  {
    ...
    desc: 'Drive organic traffic and leads.',
  ...
  },
  {
    ...
    items: ['Growth strategy', 'Market positioning', 'Process optimization'],
...
const process = [
  ...
  { n: '02', label: 'Market Research', desc: 'Surat-focused audience alignment and targeting.' },
...
const results = [
  ...
  { icon: 'contacts', stat: 'More', label: 'Leads & Inquiries' },
...
const faqs = [
  {
    q: 'Do you provide services in Surat?',
    a: 'Yes, we offer complete digital marketing services across Surat.',
  },
  {
    q: 'Can you help ecommerce businesses grow?',
    a: 'Yes, we specialize in ecommerce growth and marketplace management.',
  },
  {
    q: 'Do you provide SEO services?',
    a: 'Yes, we offer SEO, social media, and performance marketing.',
  },
  {
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Surat, Gujarat</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Looking for expert digital marketing services in Surat, Gujarat?
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              At Veyber, we help businesses in Surat grow faster with data-driven marketing strategies, high-converting campaigns, and scalable digital systems. Whether you&apos;re a startup, ecommerce seller, or manufacturing business—we help you increase visibility, generate leads, and boost revenue.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate Surat</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Surat Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Surat is one of India&apos;s fastest-growing commercial hubs, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'Textile & garment industries' },
                     { text: 'Diamond businesses' },
                     { text: 'Ecommerce sellers' },
                     { text: 'Manufacturing & export companies' }
                  ].map(({ text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates massive opportunity + intense competition. To succeed in Surat, you need: <span className="text-primary">Strong Google rankings, performance marketing strategies, and consistent brand visibility.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Surat</h3>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Surat</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Robust digital strategies to empower Surat&apos;s rapidly growing commercial sectors.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We deploy custom-developed tech integrations capturing Surat&apos;s intense ecommerce and extensive manufacturing growth.</p>
                
                <div className="space-y-4 mb-8">
                  <ul className="space-y-4">
                    {[
                      'Expertise in ecommerce & business growth',
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                  ...
                  <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Surat & Nearby Areas</h3>
                  <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                    We serve all major areas of Surat, integrating into primary economic zones optimally.
                  </p>
                  
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {['Vesu', 'Adajan', 'Varachha', 'Katargam', 'Udhna', 'Ring Road'].map((area) => (
                ...
                <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full">
                  <h3 className="text-lg font-bold font-headline mb-4 text-white">Major Cities We Serve</h3>
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {[
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Common insights regarding our local Surat operations.</p>
            </div>
          ...
          <div className="force-dark max-w-4xl mx-auto text-center relative z-10 bg-neutral-900 rounded-[2rem] sm:rounded-[3rem] border border-white/15 overflow-hidden">
            ...
            <div className="relative z-10 p-8 sm:p-12 md:p-16">
              ...
              <p className="text-base sm:text-lg text-white/75 mb-8 max-w-xl mx-auto leading-relaxed drop-shadow">
                Contact Veyber today for expert digital marketing services in Surat.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
