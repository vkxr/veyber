...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Alkapuri Vadodara | SEO, SMM, Ecommerce – Veyber',
  description: 'Looking for digital marketing services in Alkapuri Vadodara? Veyber offers ecommerce development, social media marketing, content marketing & consulting services.',
  keywords: 'Digital marketing services Alkapuri Vadodara, Social media marketing Alkapuri, Ecommerce development Alkapuri Vadodara, SEO services Alkapuri Vadodara, Digital agency Alkapuri, Marketing company Vadodara, Business consultant Alkapuri',
};
...
const pageSchema = {
  ...
  address: {
    '@type': 'PostalAddress',
    addressLocality: 'Alkapuri',
    addressRegion: 'Gujarat',
    addressCountry: 'India',
  },
  description: 'Digital marketing services in Alkapuri Vadodara including ecommerce development, social media marketing, content marketing and business consulting.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Alkapuri Vadodara?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we offer complete digital marketing services in Alkapuri and nearby areas.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we specialize in helping local and premium businesses in Alkapuri grow online.',
      },
    },
    {
      '@type': 'Question',
      name: 'Do you handle ecommerce businesses?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we provide ecommerce development and account management services.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'You can contact us for a consultation through our website.',
      },
    },
  ],
};
...
const services = [
  {
    icon: 'shopping_cart',
    title: 'Ecommerce Development in Alkapuri',
    desc: 'Launch powerful online stores that convert visitors into customers.',
    items: ['Shopify, WooCommerce & custom ecommerce websites', 'Mobile-friendly & SEO-optimized', 'Payment gateway & performance optimization'],
    href: '/ecommerce-development',
  },
  {
    icon: 'storefront',
    title: 'Ecommerce Account Management',
    desc: 'Boost your sales on marketplaces.',
    items: ['Amazon, Flipkart & Meesho management', 'Product listing optimization', 'Sales & growth strategies'],
    href: '/account-management',
  },
  {
    icon: 'share',
    title: 'Social Media Handling',
    desc: 'Build your brand on platforms like Instagram & Facebook.',
    items: ['Content creation & posting', 'Engagement & growth strategies', 'Paid ads campaigns'],
    href: '/social-media-handling',
  },
  {
    icon: 'edit_note',
    title: 'Content Marketing Services',
    desc: 'Get found on Google and attract the right audience.',
    items: ['SEO blog writing', 'Website content', 'Content strategy'],
    href: '/content-marketing',
  },
  {
    icon: 'psychology',
    title: 'Business Consulting in Alkapuri',
    desc: 'Take smarter decisions and scale faster.',
    items: ['Business growth strategies', 'Market research', 'Process optimization'],
    href: '/business-consulting',
  },
];

const process = [
  { n: '01', label: 'Business Understanding', desc: 'Understanding your unique local model & premium audience.' },
  { n: '02', label: 'Local Market Analysis', desc: 'Alkapuri-focused targeting to ensure maximum local penetration.' },
  { n: '03', label: 'Strategy Creation', desc: 'Developing bespoke and localized action plans.' },
  { n: '04', label: 'Execution', desc: 'Rolling out high-end campaigns flawlessly across channels.' },
  { n: '05', label: 'Continuous Optimization', desc: 'Monitoring metrics and refining tactics to reduce acquisition cost.' },
];

const results = [
  { icon: 'visibility', stat: 'Increased', label: 'Online Visibility' },
  { icon: 'contact_mail', stat: 'More', label: 'Qualified Leads' },
  { icon: 'payments', stat: 'Higher', label: 'Sales Conversions' },
  { icon: 'star', stat: 'Strong', label: 'Brand Positioning' },
  { icon: 'timeline', stat: 'Consistent', label: 'Business Growth' },
];

const faqs = [
  {
    q: 'Do you provide services in Alkapuri Vadodara?',
    a: 'Yes, we offer complete digital marketing services in Alkapuri and nearby areas.',
  },
  {
    q: 'Can you help local businesses grow?',
    a: 'Yes, we specialize in helping local and premium businesses in Alkapuri grow online.',
  },
  {
    q: 'Do you handle ecommerce businesses?',
    a: 'Yes, we provide ecommerce development and account management services.',
  },
  {
    q: 'How can I get started?',
    a: 'You can contact us for a consultation through our website.',
  },
];
      ...
      <main className="pt-[120px]">
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Alkapuri, Vadodara</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Grow Your Business with Veyber – <span className="text-primary font-semibold">Local Experts in Alkapuri</span>
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              Looking for professional digital marketing services in Alkapuri, Vadodara? At Veyber, we help businesses in Alkapuri build a strong online presence, generate high-quality leads, and scale with data-driven digital strategies. Whether you run a premium business, startup, or ecommerce brand, we deliver solutions that drive real results.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate Alkapuri</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Alkapuri Choose Veyber
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Alkapuri is one of the most premium commercial areas in Vadodara, bustling with high-ticket clients, corporate presence, and sophisticated retail fronts.
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'Corporate offices' },
                     { text: 'Retail brands' },
                     { text: 'Service-based businesses' },
                  ].map(({ text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This means competition is high—and only <span className="text-primary">strategic marketing wins.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Alkapuri</h3>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Alkapuri</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">High-performance digital tactics crafted for a premium local market.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">Why Veyber is the Right Choice</h2>
                <p className="text-on-surface-variant leading-relaxed mb-8">We deploy strategies meant for upscale audiences, keeping your brand positioning pristine while maximizing intake.</p>
                
                <div className="space-y-4 mb-8">
                  <ul className="space-y-4">
                    {[
                      'Local expertise in Vadodara',
                      'Customized strategies for premium markets like Alkapuri',
              ...
              <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                ...
                <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Alkapuri & Nearby Areas</h3>
                <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                  We are deeply integrated into the local grid, serving primary commercial zones seamlessly.
                </p>
                
                <div className="flex flex-wrap gap-2 mb-6 relative z-10">
                  {['Alkapuri', 'Sayajigunj', 'Fatehgunj', 'Akota', 'Nearby commercial zones of Vadodara'].map((area) => (
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm">A structured onboarding and execution roadmap to deliver maximum local value.</p>
            </div>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-20 bg-surface-container-low">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-on-surface-variant text-sm mb-10 max-w-lg mx-auto">Premium clientele targeting translates to higher ticket retention and prestige.</p>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Common insights regarding our local Alkapuri operations.</p>
            </div>
          ...
          <div className="force-dark max-w-4xl mx-auto text-center relative z-10 bg-neutral-900 rounded-[2rem] sm:rounded-[3rem] border border-white/15 overflow-hidden">
            ...
            <div className="relative z-10 p-8 sm:p-12 md:p-16">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary font-bold text-xs tracking-widest uppercase mb-6">
                <span className="relative flex h-1.5 w-1.5 shrink-0"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"/><span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-primary"/></span>
                Let&apos;s Grow Your Business in Alkapuri
              </span>
              ...
              <p className="text-base sm:text-lg text-white/75 mb-8 max-w-xl mx-auto leading-relaxed drop-shadow">
                Contact Veyber today for expert digital marketing services in Alkapuri.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
