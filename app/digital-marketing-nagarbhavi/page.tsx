...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Nagarbhavi Bangalore | Local SEO & Leads – Veyber',
  description: 'Looking for digital marketing services in Nagarbhavi Bangalore? Veyber offers SEO, social media marketing, ecommerce & business consulting services.',
  keywords: 'Digital marketing services Nagarbhavi, SEO company Nagarbhavi Bangalore, Marketing agency Nagarbhavi, Local SEO Nagarbhavi, College marketing Nagarbhavi, Coaching institute marketing Bangalore, Business consultant Nagarbhavi, West Bangalore SEO',
};
...
const pageSchema = {
  ...
  description: 'Digital marketing services in Nagarbhavi Bangalore including SEO, social media marketing, ecommerce development and business consulting.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Nagarbhavi Bangalore?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we provide complete digital marketing services in Nagarbhavi and West Bangalore.',
      },
    },
    {
      '@type': 'Question',
      name: 'Do you work with colleges and coaching institutes?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we specialize in education marketing and student lead generation.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we focus on Google ranking and local leads.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  ...
  },
  {
    ...
    desc: 'Build awareness among students & locals.',
    items: ['Instagram & Facebook campaigns', 'Reels & content creation', 'Local targeted ads'],
  ...
  },
  {
    ...
    items: ['SEO blogs & website content', 'Education + local keyword targeting', 'Authority content for institutes'],
  ...
  },
  {
    ...
    items: ['Local strategy planning', 'Lead generation funnels', 'Branding & positioning'],
...
const process = [
  ...
  { n: '02', label: 'Nagarbhavi Market Research', desc: 'Analyzing West Bangalore student & family flow.' },
  ...
  { n: '05', label: 'Optimization', desc: 'Refining data and scaling localized demand loops.' },
];

const results = [
  { icon: 'contacts', stat: 'More', label: 'Student Inquiries' },
  { icon: 'stars', stat: 'Higher', label: 'Google Rankings' },
  { icon: 'people', stat: 'Increased', label: 'Admissions/Leads' },
  { icon: 'payments', stat: 'Strong', label: 'Local Brand Visibility' },
  { icon: 'timeline', stat: 'Steady', label: 'Monthly Inquiries' },
];

const faqs = [
  {
    q: 'Do you provide services in Nagarbhavi Bangalore?',
    a: 'Yes, we provide complete digital marketing services in Nagarbhavi and West Bangalore.',
  },
  {
    q: 'Do you work with colleges and coaching institutes?',
    a: 'Yes, we specialize in education marketing and student lead generation.',
  },
  {
    q: 'Do you provide local SEO services?',
    a: 'Yes, we focus on Google ranking and local leads.',
  },
  {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="pt-[120px]">
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/25 bg-primary/[0.08] text-primary font-bold text-xs tracking-widest uppercase mb-5">
              ...
              Local SEO & Business Growth by Veyber
            </span>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Nagarbhavi, Bangalore</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Looking for trusted digital marketing services in Nagarbhavi, Bangalore?
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              At Veyber, we help local businesses, educational institutes, and service providers in Nagarbhavi grow through SEO, social media marketing, and lead generation systems designed for consistent results. We focus on visibility, trust, and steady customer acquisition.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate West Bangalore Search</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Nagarbhavi Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Nagarbhavi is one of West Bangalore&apos;s fast-developing educational and residential hubs, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'Colleges & universities' },
                     { text: 'Coaching institutes' },
                     { text: 'Residential layouts' },
                     { text: 'Clinics & healthcare services' },
                     { text: 'Local retail businesses' }
                  ].map(({ text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates high student + family-driven demand. To grow here, you need: <span className="text-primary">Strong Google visibility, local SEO ranking, and consistent lead generation.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Nagarbhavi</h3>
        ...
        {/* Our Services in Nagarbhavi */}
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Nagarbhavi</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Systemized tracking to convert Nagarbhavi&apos;s massive student and family traffic seamlessly.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We deploy localized frameworks engineered strictly to dominate search funnels around the heavy educational zones of Nagarbhavi.</p>
                
                <div className="space-y-4 mb-8">
                  <ul className="space-y-4">
                    {[
                      'Strong local SEO expertise',
                      'Education + service niche experience',
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                  ...
                  <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Nagarbhavi & Nearby</h3>
                  <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                    Our digital roots actively anchor local relevance across the entire Western expansion grid.
                  </p>
                  
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {['Nagarbhavi', 'Vijayanagar', 'Kengeri', 'Rajarajeshwari Nagar', 'Magadi Road', 'West Bangalore'].map((area) => (
                ...
                <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full">
                  ...
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {[
                      ...
                      { name: 'Vijayanagar', url: '/digital-marketing-vijayanagar' },
                      { name: 'Rajajinagar', url: '/digital-marketing-rajajinagar' },
                      { name: 'Malleshwaram', url: '/digital-marketing-malleshwaram' },
                    ].map((city) => (
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-20 bg-surface-container-low">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-on-surface-variant text-sm mb-10 max-w-lg mx-auto">Locking down the admission and customer inflow funnels completely around West Bangalore&apos;s educational ecosystem.</p>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Vital insights regarding our capacity scaling natively inside Nagarbhavi.</p>
            </div>
