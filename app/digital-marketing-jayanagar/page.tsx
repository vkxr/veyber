...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Jayanagar Bangalore | Local SEO & Leads – Veyber',
  description: 'Looking for digital marketing services in Jayanagar Bangalore? Veyber offers SEO, social media marketing, ecommerce & business consulting services.',
  keywords: 'Digital marketing services Jayanagar, SEO company Jayanagar Bangalore, Marketing agency Jayanagar, Local SEO Jayanagar, Social media marketing Jayanagar, Business consultant Jayanagar, Digital marketing Bangalore South',
};
...
const pageSchema = {
  ...
  description: 'Digital marketing services in Jayanagar Bangalore including SEO, social media marketing, ecommerce and business consulting.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Jayanagar Bangalore?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we offer complete digital marketing services in Jayanagar and nearby areas.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we specialize in clinics, coaching centers, and retail businesses.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we focus heavily on Google Maps and local SEO rankings.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  {
    ...
    desc: 'Take your business online professionally.',
    items: ['Shopify, WooCommerce & custom websites', 'Mobile-friendly design', 'Simple, conversion-focused UI'],
    href: '/ecommerce-development',
  },
  {
    icon: 'storefront',
    title: 'Ecommerce Account Management',
    desc: 'Boost your online sales channels.',
  ...
  },
  {
    ...
    desc: 'Build trust and local awareness.',
    items: ['Instagram & Facebook management', 'Content creation & posts', 'Paid ads for local reach'],
  ...
  },
  {
    ...
    items: ['SEO blog writing', 'Website content', 'Local trust-building content'],
    href: '/content-marketing',
  },
  {
    icon: 'psychology',
    title: 'Business Consulting',
    desc: 'Improve visibility and growth.',
    items: ['Local market strategy', 'Branding improvement', 'Lead generation systems'],
...
const process = [
  ...
  { n: '02', label: 'Market Research', desc: 'Local Jayanagar & South Bangalore targeting.' },
...
const faqs = [
  {
    q: 'Do you provide services in Jayanagar Bangalore?',
    a: 'Yes, we offer complete digital marketing services in Jayanagar and nearby areas.',
  },
  {
    q: 'Do you work with local businesses?',
    a: 'Yes, we specialize in clinics, coaching centers, and retail businesses.',
  },
  {
    q: 'Do you provide local SEO?',
    a: 'Yes, we focus heavily on Google Maps and local SEO rankings.',
  },
  {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="pt-[120px]">
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/25 bg-primary/[0.08] text-primary font-bold text-xs tracking-widest uppercase mb-5">
              ...
              Trusted Growth Marketing by Veyber
            </span>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Jayanagar, Bangalore</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Looking for reliable digital marketing services in Jayanagar, Bangalore?
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              At Veyber, we help local businesses, professionals, and service providers in Jayanagar grow with SEO, social media marketing, and lead generation strategies designed for long-term success. We focus on trust, visibility, and consistent customer growth.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate Jayanagar</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Jayanagar Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Jayanagar is one of Bangalore&apos;s most established and premium residential-commercial areas, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'Clinics & healthcare services' },
                     { text: 'Coaching institutes & education centers' },
                     { text: 'Retail shops & local brands' },
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates high trust-based competition. To grow here, you need: <span className="text-primary">Strong Google visibility, local SEO dominance, and reputation-driven marketing.</span>
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Jayanagar</h3>
        ...
        {/* Our Services in Jayanagar */}
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Jayanagar</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Robust digital strategies to empower Jayanagar&apos;s established and competitive ecosystem.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We engineer aggressive, performance-driven campaigns matching Jayanagar&apos;s highly established local business requirements beautifully.</p>
                
                <div className="space-y-4 mb-8">
                  <ul className="space-y-4">
                    {[
                      'Trust-focused marketing approach',
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                  ...
                  <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Jayanagar & Nearby</h3>
                  <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                    We also serve all surrounding robust residential and commercial zones seamlessly.
                  </p>
                  
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {['Jayanagar', 'J.P. Nagar', 'Banashankari', 'Basavanagudi', 'South Bangalore Region'].map((area) => (
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Common insights regarding our local Jayanagar operations.</p>
            </div>
