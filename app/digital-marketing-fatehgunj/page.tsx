...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Fatehgunj Vadodara | SEO, SMM, Ecommerce – Veyber',
  description: 'Looking for digital marketing services in Fatehgunj Vadodara? Veyber offers ecommerce development, social media marketing, content marketing & consulting services.',
  keywords: 'Digital marketing services Fatehgunj Vadodara, Social media marketing Fatehgunj, Ecommerce development Fatehgunj, SEO services Fatehgunj Vadodara, Digital agency Fatehgunj, Marketing company Vadodara, Business consultant Fatehgunj',
};
...
const pageSchema = {
  ...
  address: {
    '@type': 'PostalAddress',
    addressLocality: 'Fatehgunj',
    addressRegion: 'Gujarat',
    addressCountry: 'India',
  },
  description: 'Digital marketing services in Fatehgunj Vadodara including ecommerce development, social media marketing, content marketing and business consulting.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Fatehgunj Vadodara?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we offer complete digital marketing services in Fatehgunj and nearby areas.',
      },
    },
    {
      '@type': 'Question',
      name: 'Can you help local businesses like cafes or coaching centers?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we specialize in helping local businesses grow in high-competition areas like Fatehgunj.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we provide full social media management services.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  {
    ...
    desc: 'Take your business online and increase sales.',
    items: ['Shopify, WooCommerce & custom ecommerce websites', 'Mobile-friendly and SEO-optimized', 'Fast & secure performance'],
    href: '/ecommerce-development',
  },
  {
    icon: 'storefront',
    title: 'Ecommerce Account Management',
    desc: 'Grow your marketplace presence.',
    items: ['Amazon, Flipkart & Meesho management', 'Product listing optimization', 'Sales growth strategies'],
    href: '/account-management',
  },
  {
    icon: 'share',
    title: 'Social Media Handling in Fatehgunj',
    desc: 'Engage your audience and build your brand.',
    items: ['Instagram & Facebook management', 'Reels & content creation', 'Paid advertising campaigns'],
    href: '/social-media-handling',
  },
  {
    icon: 'edit_note',
    title: 'Content Marketing',
    desc: 'Attract customers through valuable content.',
    items: ['SEO blog writing', 'Website content', 'Content planning'],
    href: '/content-marketing',
  },
  {
    icon: 'psychology',
    title: 'Business Consulting',
    desc: 'Scale your business with the right strategy.',
    items: ['Growth planning', 'Market research', 'Business optimization'],
    href: '/business-consulting',
  },
];

const process = [
  { n: '01', label: 'Business Analysis', desc: 'Understanding your unique local model & audience.' },
  { n: '02', label: 'Local Market Research', desc: 'Fatehgunj-focused targeting to ensure maximum engagement.' },
  ...
  { n: '05', label: 'Performance Optimization', desc: 'Monitoring metrics and refining tactics for maximum ROI.' },
];

const results = [
  { icon: 'visibility', stat: 'More', label: 'Local Visibility' },
  { icon: 'contact_mail', stat: 'Increased', label: 'Footfall & Inquiries' },
  { icon: 'forum', stat: 'Higher', label: 'Engagement on Social Media' },
  { icon: 'payments', stat: 'More', label: 'Leads and Sales' },
  { icon: 'star', stat: 'Strong', label: 'Brand Presence' },
];

const faqs = [
  {
    q: 'Do you provide services in Fatehgunj Vadodara?',
    a: 'Yes, we offer complete digital marketing services in Fatehgunj and nearby areas.',
  },
  {
    q: 'Can you help local businesses like cafes or coaching centers?',
    a: 'Yes, we specialize in helping local businesses grow in high-competition areas like Fatehgunj.',
  },
  {
    q: 'Do you manage social media accounts?',
    a: 'Yes, we provide full social media management services.',
  },
  {
    q: 'How can I start?',
      ...
      <main className="pt-[120px]">
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Fatehgunj, Vadodara</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Grow Your Local Business with Veyber
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              Looking for expert digital marketing services in Fatehgunj, Vadodara? At Veyber, we help businesses in Fatehgunj build a powerful online presence, attract customers, and increase sales using data-driven marketing strategies. Whether you run a café, coaching center, startup, or ecommerce business—we create solutions that deliver real growth.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate Fatehgunj</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Fatehgunj Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Fatehgunj is one of the most active commercial and student-centric areas in Vadodara, known for its vibrant energy and competitive market.
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { icon: 'local_cafe', text: 'Cafes & restaurants' },
                     { icon: 'school', text: 'Coaching institutes' },
                     { icon: 'storefront', text: 'Retail shops' },
                     { icon: 'design_services', text: 'Service providers' },
                  ].map(({ icon, text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates high competition <span className="text-primary">+</span> high opportunity.
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-headline text-white mb-6">Who We Work With in Fatehgunj</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 relative z-10 w-full">
                  {[
                    'Cafes & restaurants',
                    'Coaching classes & institutes',
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Fatehgunj</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">High-performance digital tactics crafted for a dynamic local market.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We deploy strategies tailored for dynamic local audiences, ensuring consistent growth and engagement.</p>
                
                <div className="space-y-4 mb-8">
                  <ul className="space-y-4">
                    {[
                      'Local expertise in Vadodara',
                      'Customized strategies for Fatehgunj businesses',
                      'Affordable pricing',
                      'Dedicated support',
              ...
              <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                ...
                <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Fatehgunj & Nearby Areas</h3>
                <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                  We are deeply integrated into the local area network, serving active business hubs perfectly.
                </p>
                
                <div className="flex flex-wrap gap-2 mb-6 relative z-10">
                  {['Fatehgunj', 'Sayajigunj', 'Alkapuri', 'Karelibaug', 'Nearby areas of Vadodara'].map((area) => (
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-20 bg-surface-container-low">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-on-surface-variant text-sm mb-10 max-w-lg mx-auto">Optimized targeting translates to engaging audiences and maximizing footprint.</p>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Common insights regarding our local Fatehgunj operations.</p>
            </div>
          ...
          <div className="force-dark max-w-4xl mx-auto text-center relative z-10 bg-neutral-900 rounded-[2rem] sm:rounded-[3rem] border border-white/15 overflow-hidden">
            ...
            <div className="relative z-10 p-8 sm:p-12 md:p-16">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary font-bold text-xs tracking-widest uppercase mb-6">
                <span className="relative flex h-1.5 w-1.5 shrink-0"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"/><span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-primary"/></span>
                Let&apos;s Grow Your Business in Fatehgunj
              </span>
              ...
              <p className="text-base sm:text-lg text-white/75 mb-8 max-w-xl mx-auto leading-relaxed drop-shadow">
                Contact Veyber today for expert digital marketing services in Fatehgunj.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
