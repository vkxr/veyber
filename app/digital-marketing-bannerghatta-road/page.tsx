...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Bannerghatta Road Bangalore | Leads & SEO – Veyber',
  description: 'Looking for digital marketing services in Bannerghatta Road Bangalore? Veyber offers SEO, social media marketing, ecommerce & lead generation services.',
  keywords: 'Digital marketing services Bannerghatta Road, SEO company Bannerghatta Road Bangalore, Marketing agency Bannerghatta Road, Local SEO Bannerghatta Road, Hospital marketing Bangalore, Real estate marketing Bannerghatta Road, Healthcare SEO Bangalore, Business consultant Bannerghatta Road',
};
...
const pageSchema = {
  ...
  description: 'Digital marketing services in Bannerghatta Road Bangalore including SEO, social media marketing, ecommerce development and lead generation.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services in Bannerghatta Road Bangalore?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we provide complete digital marketing services in Bannerghatta Road and South Bangalore.',
      },
    },
    {
      '@type': 'Question',
      name: 'Do you work with hospitals and real estate companies?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we specialize in healthcare and real estate marketing.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we focus on high-intent leads and conversions.',
      },
    },
    {
      '@type': 'Question',
...
const services = [
  {
    ...
    items: ['Shopify, WooCommerce & custom websites', 'Mobile-first conversion design', 'Lead-focused UI/UX'],
  ...
  },
  {
    ...
    items: ['Amazon, Flipkart & Meesho management', 'Product optimization', 'Marketplace growth strategy'],
    href: '/account-management',
  },
  {
    icon: 'share',
    title: 'Social Media Marketing',
    desc: 'Generate high-intent local leads.',
    items: ['Instagram & Facebook ads', 'Hospital & real estate campaigns', 'Video + reel marketing'],
    href: '/social-media-handling',
  },
  {
    icon: 'edit_note',
    title: 'Content Marketing',
    desc: 'Build authority in competitive niches.',
    items: ['SEO blogs & landing pages', 'Healthcare + real estate keywords', 'Local authority content'],
    href: '/content-marketing',
  },
  {
    icon: 'psychology',
    title: 'Business Consulting',
    desc: 'Improve conversion systems.',
    items: ['Real estate funnel strategy', 'Healthcare lead generation planning', 'Branding & positioning'],
    href: '/business-consulting',
  },
];

const process = [
  { n: '01', label: 'Market Analysis', desc: 'Identify your true potential and healthcare/retail bottlenecks.' },
  { n: '02', label: 'Audience Segmentation', desc: 'Isolating precise buyer and patient intents along the corridor.' },
...
const results = [
  { icon: 'contacts', stat: 'High-quality', label: 'Patient / Buyer Leads' },
  { icon: 'stars', stat: 'Better', label: 'Google Rankings' },
  { icon: 'people', stat: 'Strong', label: 'Brand Visibility' },
  { icon: 'payments', stat: 'Increased', label: 'Inquiries & Bookings' },
  { icon: 'timeline', stat: 'Consistent', label: 'Lead Flow' },
];

const faqs = [
  {
    q: 'Do you provide services in Bannerghatta Road Bangalore?',
    a: 'Yes, we provide complete digital marketing services in Bannerghatta Road and South Bangalore.',
  },
  {
    q: 'Do you work with hospitals and real estate companies?',
    a: 'Yes, we specialize in healthcare and real estate marketing.',
  },
  {
    q: 'Do you provide lead generation services?',
    a: 'Yes, we focus on high-intent leads and conversions.',
  },
  {
      ...
      <main className="pt-[120px]">
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/25 bg-primary/[0.08] text-primary font-bold text-xs tracking-widest uppercase mb-5">
              ...
              High-Intent Lead Generation by Veyber
            </span>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>In Bannerghatta Road</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Looking for result-driven digital marketing services in Bannerghatta Road, Bangalore?
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              At Veyber, we help hospitals, real estate developers, educational institutions, and local businesses along Bannerghatta Road grow through SEO, social media marketing, and performance-based lead generation systems. We focus on visibility, inquiries, and measurable business growth.
            </p>
            ...
            <Link href="/contact" className="group relative px-7 sm:px-9 py-3.5 sm:py-4 bg-gradient-to-r from-[#aec6ff] to-[#4f8eff] text-[#001a42] font-bold rounded-full text-base sm:text-lg overflow-hidden transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_52px_rgba(174,198,255,0.38)] active:scale-95">
              <span className="relative z-10 flex items-center gap-2"><span className="material-symbols-outlined text-[20px]">rocket_launch</span>Dominate Local Search</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Businesses in Bannerghatta Road Need Digital Marketing
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Bannerghatta Road is one of Bangalore&apos;s most important growth corridors, known for:
                </p>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                     { text: 'Major hospitals & healthcare chains' },
                     { text: 'Apartment townships & gated communities' },
                     { text: 'Educational institutions & universities' },
                     { text: 'Shopping malls & retail hubs' },
                     { text: 'Strong residential + commercial mix' }
                  ].map(({ text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates high search volume and high-value customer intent. To grow here, you need: <span className="text-primary">Strong Google visibility, local SEO dominance, and high-conversion lead funnels.</span>
                </p>
              </div>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Services in Bannerghatta Road</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Systemized tracking to convert high-value healthcare and commercial traffic into solid pipeline.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="h-full flex flex-col justify-center">
                ...
                <p className="text-on-surface-variant leading-relaxed mb-8">We deploy localized and aggressive frameworks engineered strictly for high-stake healthcare, retail, and real estate closures targeting Bannerghatta Road.</p>
                
                <div className="space-y-4 mb-8">
                  <ul className="space-y-4">
                    {[
                      'Strong healthcare + real estate marketing expertise',
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-surface-container rounded-3xl border border-primary/20 p-6 sm:p-10 relative overflow-hidden h-full">
                  ...
                  <h3 className="text-2xl font-bold font-headline mb-3 text-white">Serving Bannerghatta Road & Nearby</h3>
                  <p className="text-on-surface-variant text-sm mb-6 leading-relaxed">
                    Our local market pipelines tightly grip the major arteries running through Southern Bangalore.
                  </p>
                  
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {['Bannerghatta Road', 'JP Nagar', 'BTM Layout', 'Electronic City', 'Arekere', 'South Bangalore'].map((area) => (
                ...
                <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full">
                  ...
                  <div className="flex flex-wrap gap-2 relative z-10">
                    {[
                      ...
                      { name: 'JP Nagar', url: '/digital-marketing-jp-nagar' },
                      { name: 'BTM Layout', url: '/digital-marketing-btm-layout' },
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-20 bg-surface-container-low">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-on-surface-variant text-sm mb-10 max-w-lg mx-auto">Intercepting high-ticket healthcare queries directly mapping to Bannerghatta&apos;s intense corporate ecosystem.</p>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Vital insights regarding our capacity targeting health + real estate systems along Bannerghatta Road.</p>
            </div>
