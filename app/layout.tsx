  ...
  return (
    <html lang="en" className="dark" suppressHydrationWarning>
      <head>
        ...
        {/* Defer Material Symbols stylesheet to avoid render blocking */}
        <link rel="preload" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0..1,0&display=block" as="style" />
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0..1,0&display=block" media="print" id="material-symbols" />
        <Script id="material-symbols-loader" strategy="beforeInteractive" dangerouslySetInnerHTML={{__html: `document.getElementById('material-symbols').media='all';`}} />
        <noscript>
