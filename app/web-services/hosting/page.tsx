...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Is this shared hosting?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'No. We provide managed cloud hosting solutions. This means your website\'s resources are isolated and not impacted by other heavily trafficked sites, ensuring consistent fast performance.',
      },
    },
    {
      '@type': 'Question',
      name: 'Will my website go down during migration?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'We handle website migrations with extreme care, using a zero-downtime methodology. Your customers won\'t even notice the switch.',
      },
    },
    {
      '@type': 'Question',
      name: 'What happens if my site gets hacked?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Because we implement strict security measures and Web Application Firewalls, hacking is extremely rare. However, if an issue occurs, our daily automated backups allow us to restore a clean version of your site instantly.',
      },
    },
    {
      '@type': 'Question',
      name: 'Can the server handle traffic spikes?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Our cloud infrastructure is scalable. If you are expecting a massive surge in traffic (like a sale event), we can temporarily scale your server resources to handle the load.',
      },
    }
  ],
};
      ...
      <main className="pt-[120px]">
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              ...
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>cloud infrastructure.</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-8 leading-relaxed">
              Don't let cheap hosting ruin your business reputation. We provide enterprise-grade, fully managed cloud hosting that ensures your site is always online, fast, and secure.
            </p>
            ...
            <div className="mt-12 flex flex-wrap justify-center gap-6 sm:gap-10">
              {[
                ...
                { val: 'Daily', label: 'Cloud Backups' },
                { val: 'Free', label: 'SSL Included' },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                ...
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Shared, budget hosting plans often result in slow load times, frequent downtimes, and severe security vulnerabilities. A slow website frustrates users and negatively impacts your Google rankings.
                </p>
                <p className="text-on-surface-variant leading-relaxed mb-8">
                  Our managed hosting solutions utilize premium cloud infrastructure. We handle the server maintenance, security patching, and speed optimization, ensuring your website performs flawlessly even during traffic spikes.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    { icon: 'speed', text: 'Lightning Fast Speeds' },
                    { icon: 'security', text: 'Protection from Hacks & Malware' },
                    { icon: 'backup', text: 'Automated Daily Backups' },
                    { icon: 'support_agent', text: 'Priority Technical Support' },
                  ].map(({ icon, text }) => (
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Hosting Features & Benefits</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Everything you need for a robust and secure online presence.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {[{"icon":"cloud","title":"Managed Cloud Hosting","desc":"High-performance cloud servers configured specifically for your website's tech stack.","items":["Dedicated Resources","Scalable Architecture","Optimized Server Environment"]},{"icon":"lock","title":"Free SSL Certificates","desc":"Secure your website data and build customer trust with robust encryption.","items":["Automated Renewal","HTTPS Encryption","SEO Ranking Boost"]},{"icon":"cloud_sync","title":"Automated Backups","desc":"Sleep easy knowing your data is safe. We maintain automated daily and weekly backups.","items":["Off-site Storage","One-Click Restoration","Disaster Recovery Plan"]},{"icon":"shield","title":"Advanced Security","desc":"Proactive protection against brute-force attacks, malware, and DDoS attempts.","items":["Web Application Firewall (WAF)","Malware Scanning","IP Blocking"]},{"icon":"network_node","title":"CDN Integration","desc":"Content Delivery Network integration to serve your website assets from global edge servers instantly.","items":["Global Asset Delivery","Reduced Latency","Bandwidth Optimization"]},{"icon":"query_stats","title":"Uptime Monitoring","desc":"24/7 proactive monitoring to ensure your website is always accessible to your customers.","items":["Instant Alerts","Performance Tracking","99.9% Uptime SLA"]}].map((srv: any) => (
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-20 bg-surface-container-low">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">Website Hosting in Gujarat — Local Advantage</h2>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[{"n":"01","label":"Assessment","desc":"We evaluate your current website traffic and resource requirements."},{"n":"02","label":"Server Provisioning","desc":"Setting up the optimized cloud environment tailored to your needs."},{"n":"03","label":"Migration","desc":"Seamlessly transferring your website with zero downtime."},{"n":"04","label":"Security Configuration","desc":"Installing SSL, firewalls, and configuring automated backups."},{"n":"05","label":"Optimization","desc":"Tuning server settings and integrating CDNs for maximum speed."},{"n":"06","label":"Ongoing Management","desc":"Continuous monitoring, updates, and priority technical support."}].map((step: any, i: number) => (
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col gap-4">
              {[{"q":"Is this shared hosting?","a":"No. We provide managed cloud hosting solutions. This means your website's resources are isolated and not impacted by other heavily trafficked sites, ensuring consistent fast performance."},{"q":"Will my website go down during migration?","a":"We handle website migrations with extreme care, using a zero-downtime methodology. Your customers won't even notice the switch."},{"q":"What happens if my site gets hacked?","a":"Because we implement strict security measures and Web Application Firewalls, hacking is extremely rare. However, if an issue occurs, our daily automated backups allow us to restore a clean version of your site instantly."},{"q":"Can the server handle traffic spikes?","a":"Yes. Our cloud infrastructure is scalable. If you are expecting a massive surge in traffic (like a sale event), we can temporarily scale your server resources to handle the load."}].map((item: any, i: number) => (
