...
export const metadata: Metadata = {
  title: 'Digital Marketing Services in Gujarat | SEO, SMM, Ecommerce – Veyber',
  description: 'Looking for digital marketing services in Gujarat? Veyber offers SEO, ecommerce, social media marketing & business consulting across Gujarat.',
  keywords: 'Digital marketing services Gujarat, SEO company Gujarat, Digital marketing agency Gujarat, Ecommerce marketing Gujarat, Social media marketing Gujarat, Business consultant Gujarat, Online marketing Gujarat',
};
...
const pageSchema = {
  ...
  description: 'Digital marketing services in Gujarat including ecommerce development, SEO, social media marketing and business consulting.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do you provide services across Gujarat?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we offer digital marketing services across all major cities and regions in Gujarat.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'We work with ecommerce, manufacturing, startups, and service-based businesses.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, we offer end-to-end services including SEO, social media, ecommerce, and consulting.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'You can contact us through our website for a consultation.',
      },
    },
  ],
};
...
const services = [
  {
    ...
    desc: 'Build powerful online stores that scale.',
    items: ['Shopify, WooCommerce & custom ecommerce solutions', 'Mobile-friendly & high-performance', 'Conversion-focused design'],
  ...
  },
  {
    ...
    desc: 'Build your brand and engage your audience.',
...
const process = [
  { n: '01', label: 'Business & Market Analysis', desc: 'Understanding your specific niche, audience, and local competitors fully.' },
  { n: '02', label: 'Strategy Development', desc: 'Crafting comprehensive action plans to hit core performance KPIs metrics.' },
  { n: '03', label: 'Execution', desc: 'Launching campaigns, content, stores, and ad-sets professionally.' },
  { n: '04', label: 'Optimization', desc: 'Refining data and running aggressive A/B testing to decrease acquisition cost.' },
  { n: '05', label: 'Scaling', desc: 'Accelerating growth securely to conquer new regions and grab market share.' },
];

const results = [
  { icon: 'trending_up', stat: 'Increased', label: 'Online Visibility' },
  { icon: 'ads_click', stat: 'High-Quality', label: 'Leads' },
  { icon: 'people', stat: 'Better', label: 'Engagement' },
  { icon: 'payments', stat: 'Higher', label: 'Conversions' },
  { icon: 'bolt', stat: 'Long-Term', label: 'Business Growth' },
];

const faqs = [
  {
    q: 'Do you provide services across Gujarat?',
    a: 'Yes, we offer digital marketing services across all major cities and regions in Gujarat.',
  },
  {
    q: 'Which industries do you work with?',
    a: 'We work with ecommerce, manufacturing, startups, and service-based businesses.',
  },
  {
    q: 'Do you provide complete digital marketing solutions?',
    a: 'Yes, we offer end-to-end services including SEO, social media, ecommerce, and consulting.',
  },
  {
    q: 'How can I get started?',
    a: 'You can contact us through our website for a consultation.',
  },
];

const locationSilo = [
  { city: 'Vadodara', href: '/digital-marketing-vadodara' },
  { city: 'Ahmedabad', href: '/digital-marketing-ahmedabad' },
      ...
      <main className="pt-[120px]">
        ...
        <section className="relative px-4 sm:px-8 py-12 sm:py-20 md:py-28 overflow-hidden" style={{background:'radial-gradient(ellipse 110% 55% at 50% -5%, rgba(174,198,255,0.07) 0%, transparent 70%)'}}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold font-headline tracking-tight mb-5 leading-[1.05] text-white">
              Grow Your Business Across<br/>
              <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" style={{filter:'drop-shadow(0 0 28px rgba(174,198,255,0.3))'}}>Gujarat with Veyber</span>
            </h1>
            <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto mb-4 leading-relaxed">
              Looking for professional digital marketing services in <span className="text-primary font-semibold">Gujarat?</span>
            </p>
            <p className="text-sm sm:text-base text-on-surface-variant max-w-xl mx-auto mb-8 leading-relaxed">
              At Veyber, we help businesses across Gujarat build strong online presence, generate high-quality leads, and scale with data-driven digital marketing strategies. From startups to enterprises—we create custom growth systems that deliver real results.
            </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">
                  Why Digital Marketing is Essential in Gujarat
                </h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">
                  Gujarat is one of India&apos;s fastest-growing business states, known for its dynamic industrial expansion and booming commercial environment.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                  {[
                    { icon: 'factory', text: 'Industrial growth' },
                    { icon: 'shopping_cart', text: 'Ecommerce expansion' },
                    { icon: 'emoji_objects', text: 'Startup ecosystem' },
                    { icon: 'insights', text: 'Competitive local markets' },
                  ].map(({ icon, text }) => (
                ...
                <p className="text-white font-semibold text-lg border-l-4 border-primary pl-4 py-2 border-outline-variant/10">
                  👉 This creates huge opportunity <span className="text-primary">+</span> intense competition.
                </p>
              </div>
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden">
                ...
                <div className="space-y-4 mb-6">
                  {[
                    { icon: 'travel_explore', t: 'Strong Google rankings' },
                    { icon: 'visibility', t: 'Consistent brand visibility' },
                    { icon: 'monitoring', t: 'Performance-driven marketing' },
                  ].map((ind) => (
                ...
                <p className="text-on-surface-variant text-sm leading-relaxed border-t border-outline-variant/10 pt-4">
                  We implement robust digital architectures designed to dominate both state and national markets.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-headline mb-4">Our Digital Marketing Services in Gujarat</h2>
              <p className="text-on-surface-variant max-w-xl mx-auto text-sm sm:text-base">Comprehensive, end-to-end solutions that elevate businesses above competitors.</p>
            </div>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-20 bg-surface-container-low">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <h2 className="text-2xl sm:text-4xl font-bold font-headline mb-5 leading-tight">Gujarat Coverage & Industries We Serve</h2>
                <p className="text-on-surface-variant leading-relaxed mb-6">We deploy aggressive digital infrastructures for specific target zones and local niches.</p>
                <div className="mb-8">
                  <h3 className="text-lg font-bold text-white mb-4">Industries We Work With</h3>
                  <div className="flex flex-wrap gap-2">
                    {['Ecommerce businesses', 'Manufacturing & industrial companies', 'Startups & SMEs', 'Service providers', 'Local businesses'].map((ind) => (
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3">
                    {[
                      'Gujarat-focused marketing strategies',
              ...
              <div className="bg-surface-container rounded-3xl border border-outline-variant/10 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col justify-center">
                <div className="absolute top-0 right-0 w-40 h-40 bg-primary/10 blur-[50px] rounded-full pointer-events-none"/>
                <h3 className="text-xl sm:text-2xl font-bold font-headline mb-4 relative z-10">Cities We Serve in Gujarat</h3>
                <p className="text-on-surface-variant text-sm mb-6 relative z-10">We provide digital marketing services across major cities and all nearby areas.</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 relative z-10">
                  ...
                  <div className="col-span-full mt-2 text-center text-primary text-xs font-semibold">
                    👉 And all nearby areas across Gujarat
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p className="text-on-surface-variant text-sm">Clear insights on how we operate across Gujarat.</p>
            </div>
          ...
          <div className="force-dark max-w-4xl mx-auto text-center relative z-10 bg-neutral-900 rounded-[2rem] sm:rounded-[3rem] border border-white/15 overflow-hidden">
            ...
            <div className="relative z-10 p-8 sm:p-12 md:p-16">
              ...
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-white mb-4 tracking-tight drop-shadow-xl">
                Ready to scale your business across Gujarat?
              </h2>
              <p className="text-base sm:text-lg text-white/75 mb-8 max-w-xl mx-auto leading-relaxed drop-shadow">
                Contact Veyber today for expert digital marketing services tailored to your market.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
