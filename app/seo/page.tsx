        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[{"n":"01","label":"SEO Audit","desc":"We run a deep technical and content audit of your current site."},{"n":"02","label":"Keyword Research","desc":"Identifying the most profitable search terms for your specific niche."},{"n":"03","label":"On-Page Optimization","desc":"Updating meta tags, headings, and copy for target keywords."},{"n":"04","label":"Technical Fixes","desc":"Improving site speed, mobile-friendliness, and fixing crawl errors."},{"n":"05","label":"Link Building","desc":"Acquiring high-authority backlinks to boost your domain trust."},{"n":"06","label":"Monitor & Adjust","desc":"Continuous tracking and tweaking to maintain top positions."}].map((step: any, i: number) => (
