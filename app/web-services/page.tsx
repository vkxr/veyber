        ...
        <section className="px-4 sm:px-8 py-14 sm:py-24 bg-surface">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[{"n":"01","label":"Requirements Gathering","desc":"We define the technical stack, architecture requirements, and hosting needs."},{"n":"02","label":"Design & Prototyping","desc":"Creating wireframes and UI designs focused on user experience and conversion."},{"n":"03","label":"Development","desc":"Writing clean, scalable code using modern frameworks like React and Next.js."},{"n":"04","label":"Infrastructure Setup","desc":"Configuring servers, databases, and continuous integration pipelines."},{"n":"05","label":"Testing & QA","desc":"Rigorous testing for performance, security, and cross-browser compatibility."},{"n":"06","label":"Deployment & Maintenance","desc":"Going live with zero downtime and providing ongoing server monitoring and updates."}].map((step: any, i: number) => (
